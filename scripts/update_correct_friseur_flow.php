...
try {
    ...
    if ($publishResponse->successful()) {
        ...
        echo "⚠️ Agent publish had issue (might be OK): " . $publishResponse->status() . "\n\n";
    }
    ...
    echo "✅ Agent published (Version " . ($flow['version'] ?? 'unknown') . " → " . ($updatedFlow['version'] ?? 'unknown') . ")\n";
