...
/**
 * Publish Agent with Flow V14
 *
 * Flow V14 has correct parameter mapping: {{call.call_id}}
 * This should resolve the empty call_id issue.
 */
...
echo "🚀 Publishing Agent with Flow V14...\n\n";
...
// Step 2: Update agent to explicitly use Flow V14 and trigger publish
$updatePayload = [
    'agent_name' => $agent['agent_name'],
    'response_engine' => [
        'type' => 'conversation-flow',
        'conversation_flow_id' => $flowId,
        'version' => 14  // Use V14 with fixed parameter mapping
    ],
...
echo "🔄 Updating agent to use Flow V14...\n\n";
...
if ($httpCode === 200 || $httpCode === 201) {
    ...
    if ($result['is_published']) {
        echo "🎉 🎉 🎉 SUCCESS! Agent ist jetzt LIVE mit Flow V14!\n\n";
        ...
        echo "   ✅ call_id = echte Call-ID (nicht leer!)\n\n";
        ...
        echo "🔧 KRITISCH: API kann nicht automatisch publishen!\n";
        echo "   Manuelle Aktion erforderlich im Dashboard.\n";
    }
