...
trait BelongsToCompany
{
    ...
    protected static function getCurrentCompanyId(): ?int
    {
        ...
        if (app()->bound('current_company_id')) {
            ...
            // Validate this was set by trusted code (e.g., job middleware)
            if (app()->bound('company_context_source') && app('company_context_source') === 'trusted_job') {
     ...
     */
    public static function setTrustedCompanyContext(int $companyId): void
    {
