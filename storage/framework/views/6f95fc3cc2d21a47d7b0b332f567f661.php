    ...
    <div class="askpro-login-wrapper">
        ...
        <div class="askpro-branding-panel">
            ...
            <div class="askpro-branding-content">
                ...
                <p class="askpro-subtitle"><?php echo e(__('Intelligente Terminverwaltung mit KI-gestuetzter Sprachassistenz.')); ?></p>
                ...
                <div class="askpro-features">
                    <div class="askpro-feature">
                        ...
                        <span><?php echo e(__('Automatische Terminbuchung')); ?></span>
                    </div>
                    <div class="askpro-feature">
                        <div class="askpro-feature-icon">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span><?php echo e(__('24/7 KI-Telefonassistent')); ?></span>
                    </div>
                    <div class="askpro-feature">
                        <div class="askpro-feature-icon">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span><?php echo e(__('Echtzeit-Analytics')); ?></span>
                    </div>
                </div>
                ...
                <div class="askpro-stats">
                    <div class="askpro-stat">
                        ...
                        <div class="askpro-stat-label"><?php echo e(__('Unternehmen')); ?></div>
                    </div>
                    <div class="askpro-stat-divider"></div>
                    <div class="askpro-stat">
                        <div class="askpro-stat-value">10K+</div>
                        <div class="askpro-stat-label"><?php echo e(__('Termine/Monat')); ?></div>
                    </div>
                    <div class="askpro-stat-divider"></div>
                    <div class="askpro-stat">
                        <div class="askpro-stat-value">99.9%</div>
                        <div class="askpro-stat-label"><?php echo e(__('Uptime')); ?></div>
                    </div>
                </div>
            </div>
        </div>
...
<?php endif; ?>
                ...
                <div class="askpro-form-footer">
                    <p class="text-xs text-gray-500 dark:text-gray-400 text-center">
                        <?php echo e(__('Mit der Anmeldung akzeptieren Sie unsere')); ?>

                        <a href="#" class="text-primary-600 hover:text-primary-500 dark:text-primary-400"><?php echo e(__('Nutzungsbedingungen')); ?></a>
                        <?php echo e(__('und')); ?>

                        <a href="#" class="text-primary-600 hover:text-primary-500 dark:text-primary-400"><?php echo e(__('Datenschutz')); ?></a>.
                    </p>
                </div>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /var/www/api-gateway/resources/views/filament/pages/auth/login.blade.php ENDPATH**/ ?>