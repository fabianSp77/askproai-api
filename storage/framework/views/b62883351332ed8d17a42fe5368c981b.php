        ...
        <div class="test-grid">
            ...
            <div class="test-card">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="input-callid-check" value="test_<?php echo e(uniqid()); ?>" placeholder="call_...">
                </div>
            ...
            <div class="test-card">
                ...
                <div class="form-group">
                    <label>Call ID</label>
                    <input type="text" id="input-callid-extract" value="test_<?php echo e(uniqid()); ?>">
                </div>
            ...
            <div class="test-card">
                ...
                <div class="form-group">
                    <label>Call ID</label>
                    <input type="text" id="input-callid-avail" value="test_<?php echo e(uniqid()); ?>">
                </div>
            ...
            <div class="test-card">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="input-datetime-book" value="<?php echo e(date('Y-m-d')); ?> 10:00" placeholder="YYYY-MM-DD HH:MM">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label>Call ID</label>
                    <input type="text" id="input-callid-book" value="test_<?php echo e(uniqid()); ?>">
                </div>
...
<?php /**PATH /var/www/api-gateway/resources/views/docs/api-testing.blade.php ENDPATH**/ ?>