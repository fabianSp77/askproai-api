...
>
    <head>
        <script src="<?php echo e(asset('js/final-solution.js?v=' . time())); ?>"></script>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1033333896-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH /var/www/api-gateway/resources/views/vendor/filament-panels/components/layout/base.blade.php ENDPATH**/ ?>