# Incident Report: INC-20251102160001-z9lr0s

**Status**: 🔄 OPEN
**Severity**: 🟠 HIGH
**Category**: backup
**Created**: 2025-11-02 16:00:01 CET
...
**Details**:
Last backup was 25 hours ago (file: backup-20251101_142604.tar.gz). Expected interval: 8 hours (3x daily)
...
| Time | Event |
|------|-------|
| 2025-11-02T16:00:01+01:00 | Incident created |
