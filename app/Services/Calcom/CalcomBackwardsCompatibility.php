...
class CalcomBackwardsCompatibility
{
    ...
    public function __construct(Container $container, ?string $apiKey = null)
    {
        $this->container = $container;
        $this->logDeprecations = config('services.calcom.log_v1_usage', true);

        // Lazy load v2Service to avoid circular dependency
    ...
    /**
     * Get V2 service instance (lazy loading).
     */
    private function getV2Service(): CalcomV2Service
    {
        if (! isset($this->v2Service)) {
            // Use container to resolve dependencies properly
            $this->v2Service = $this->container->make(CalcomV2Service::class, [
    ...
    public function checkAvailability($eventTypeId, $dateFrom, $dateTo)
    {
        ...
        try {
            ...
            $slots = $this->getV2Service()->getSlots(
                (int) $eventTypeId,
                $dateFrom,
                $dateTo,
                'Europe/Berlin'
    ...
    public function bookAppointment($eventTypeId, $startTime, $endTime, $customerData, $notes = null)
    {
        ...
        try {
            ...
            $result = $this->getV2Service()->createBooking($bookingData);
    ...
    public function getEventTypes($companyId = null)
    {
        ...
        try {
            ...
            $result = $this->getV2Service()->getEventTypes($teamSlug);
    ...
    public function getBookings($params = [])
    {
        ...
        try {
            ...
            $result = $this->getV2Service()->getBookings($filters);
    ...
    public function cancelBooking($bookingId, $reason = null)
    {
        ...
        try {
            $result = $this->getV2Service()->cancelBooking($bookingId, $reason);
    ...
    public function setApiKey(string $apiKey): self
    {
        ...
        // Store API key for lazy loading
        $this->apiKey = $apiKey;
        // Reset V2 service to force recreation with new API key
        unset($this->v2Service);
