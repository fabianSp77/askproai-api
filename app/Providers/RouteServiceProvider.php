...
class RouteServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $this->routes(function () {
            ...
            // Cal.com Webhook Routes - MUST be first and without any middleware
            Route::post('/webhooks/calcom', [\App\Http\Controllers\CalcomWebhookController::class, 'handle'])
                ->name('webhooks.calcom.post');
