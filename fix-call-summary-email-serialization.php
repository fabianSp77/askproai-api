...
echo "=== FIX CallSummaryEmail Serialization ===\n\n";
...
file_put_contents(app_path('Mail/CallSummaryEmail.php'), $source);

echo "✅ CallSummaryEmail has been fixed!\n\n";
echo "Key changes:\n";
echo "1. Store only call ID instead of full object\n";
echo "2. Load call with relationships in build() method\n";
echo "3. Add build() calls in envelope(), content(), and attachments()\n";
echo "4. Add error handling for CSV generation\n";
echo "5. Set tries property for retry attempts\n";