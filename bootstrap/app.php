...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware) {
        ...
        // Define the web middleware group properly for Laravel 11
        ...
        $middleware->alias([
            ...
            'portal.session.share' => App\Http\Middleware\SharePortalSession::class,
            // DISABLED: 'demo.mode.auth' => \App\Http\Middleware\DemoModeAuth::class,
