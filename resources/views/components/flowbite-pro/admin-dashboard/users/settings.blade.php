...
<div class="{{ $attributes->get('class', '') }} gap-4 p-4 xl:grid xl:grid-cols-2">
  <div class="{{ $attributes->get('class', '') }} mb-4 rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800 sm:p-6 xl:mb-0">
    <h2 class="{{ $attributes->get('class', '') }} text-xl font-bold text-gray-900 dark:text-white">Account</h2>
    <div class="{{ $attributes->get('class', '') }} my-4 flex w-full items-center">
      <img class="{{ $attributes->get('class', '') }} mb-4 me-4 h-20 w-20 rounded-full sm:mb-0" src="/images/users/bonnie-green.png" alt="Bonnie avatar" />
      <div class="{{ $attributes->get('class', '') }} w-full items-center space-x-0 space-y-4 sm:flex sm:space-x-4 sm:space-y-0">
        <button
          type="button"
    ...
    <form action="#">
      <div class="{{ $attributes->get('class', '') }} mb-4 grid gap-4 sm:mb-6 sm:grid-cols-2">
        <div>
          <label for="username" class="{{ $attributes->get('class', '') }} mb-2 flex text-sm font-medium text-gray-900 dark:text-white">Username*</label>
          <input
            type="text"
            name="username"
            id="username"
        ...
        <div>
          <label for="fullname" class="{{ $attributes->get('class', '') }} mb-2 flex text-sm font-medium text-gray-900 dark:text-white">Full name*</label>
          <input
            type="text"
            name="fullname"
            id="fullname"
        ...
        <div>
          <label for="email" class="{{ $attributes->get('class', '') }} mb-2 flex text-sm font-medium text-gray-900 dark:text-white">Your email*</label>
          <div class="{{ $attributes->get('class', '') }} relative">
            <div class="{{ $attributes->get('class', '') }} pointer-events-none absolute inset-y-0 start-0 top-0 flex items-center ps-3.5">
            ...
            <input
              ...
              name="email"
              id="email"
              class="{{ $attributes->get('class', '') }} block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 ps-10 text-sm text-gray-900 focus:border-primary-600 focus:ring-primary-600 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500"
        ...
        <div>
          <label for="phone-input" class="{{ $attributes->get('class', '') }} mb-2 flex text-sm font-medium text-gray-900 dark:text-white">Phone number</label>
          <div class="{{ $attributes->get('class', '') }} relative">
            <div class="{{ $attributes->get('class', '') }} pointer-events-none absolute inset-y-0 start-0 top-0 flex items-center ps-3.5">
              <svg class="{{ $attributes->get('class', '') }} h-4 w-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                <path
        ...
        <div>
          <label for="timezone" class="{{ $attributes->get('class', '') }} mb-2 flex items-center text-sm font-medium text-gray-900 dark:text-white"
            >Timezone<button data-tooltip-target="tooltip-timezone-description" class="{{ $attributes->get('class', '') }} ms-1 text-gray-400 hover:text-gray-900 dark:hover:text-white" type="button">
        ...
        <div>
          <label for="account-type" class="{{ $attributes->get('class', '') }} mb-2 flex items-center text-sm font-medium text-gray-900 dark:text-white"
            >Account Type<button data-tooltip-target="tooltip-account-type-description-2" class="{{ $attributes->get('class', '') }} ms-1 text-gray-400 hover:text-gray-900 dark:hover:text-white" type="button">
              <svg class="{{ $attributes->get('class', '') }} h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                <path
                  fill-rule="evenodd"
                  d="M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12Zm9.008-3.018a1.502 1.502 0 0 1 2.522 1.159v.024a1.44 1.44 0 0 1-1.493 1.418 1 1 0 0 0-1.037.999V14a1 1 0 1 0 2 0v-.539a3.44 3.44 0 0 0 2.529-3.256 3.502 3.502 0 0 0-7-.255 1 1 0 0 0 2 .076c.014-.398.187-.774.48-1.044Zm.982 7.026a1 1 0 1 0 0 2H12a1 1 0 1 0 0-2h-.01Z"
      ...
      <h3 class="{{ $attributes->get('class', '') }} mb-1 text-lg font-bold text-gray-900 dark:text-white">Linked accounts</h3>
      <p class="{{ $attributes->get('class', '') }} mb-4 text-gray-500 dark:text-gray-400 sm:mb-6">We use this to let you sign in and populate your profile information</p>
      <!-- Toggle 1 -->
      <div class="{{ $attributes->get('class', '') }} mb-4 rounded-lg border border-gray-200 p-4 dark:border-gray-700">
        <div class="{{ $attributes->get('class', '') }} mb-2 flex items-center justify-between">
          <svg class="{{ $attributes->get('class', '') }} h-8 text-gray-900 dark:text-white" viewBox="0 0 68 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
          ...
          <label class="{{ $attributes->get('class', '') }} inline-flex items-center cursor-pointer">
            <input id="github-connect" type="checkbox" value="" class="{{ $attributes->get('class', '') }} sr-only peer" checked>
        ...
        <div class="{{ $attributes->get('class', '') }} text-base font-normal text-gray-500 dark:text-gray-400">Integrate your knowledge base and customer success seamlessy with your app.</div>
      </div>
      <!-- Toggle 2 -->
      <div class="{{ $attributes->get('class', '') }} mb-4 rounded-lg border border-gray-200 p-4 dark:border-gray-700">
        <div class="{{ $attributes->get('class', '') }} mb-2 flex items-center justify-between">
          <svg class="{{ $attributes->get('class', '') }} h-8" viewBox="0 0 57 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
          ...
          <label class="{{ $attributes->get('class', '') }} inline-flex items-center cursor-pointer">
            <input id="google-connect" type="checkbox" value="" class="{{ $attributes->get('class', '') }} sr-only peer" checked>
            <div class="{{ $attributes->get('class', '') }} relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 dark:peer-focus:ring-primary-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-primary-600 dark:peer-checked:bg-primary-600"></div>
          </label>
        </div>
        <div class="{{ $attributes->get('class', '') }} text-base font-normal text-gray-500 dark:text-gray-400">Integrate your knowledge base and customer success seamlessy with your app.</div>
      ...
      <!-- Toggle 3 -->
      <div class="{{ $attributes->get('class', '') }} rounded-lg border border-gray-200 p-4 dark:border-gray-700">
        <div class="{{ $attributes->get('class', '') }} mb-2 flex items-center justify-between">
          <svg class="{{ $attributes->get('class', '') }} h-8 text-gray-900 dark:text-white" viewBox="0 0 84 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
          ...
          <label class="{{ $attributes->get('class', '') }} inline-flex items-center cursor-pointer">
            <input id="mailchimp-connect" type="checkbox" value="" class="{{ $attributes->get('class', '') }} sr-only peer">
            <div class="{{ $attributes->get('class', '') }} relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 dark:peer-focus:ring-primary-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-primary-600 dark:peer-checked:bg-primary-600"></div>
          </label>
        </div>
        <div class="{{ $attributes->get('class', '') }} text-base font-normal text-gray-500 dark:text-gray-400">Messages that you share with your customers, such as emails or advertising.</div>
      </div>
      <button
        type="submit"
        class="{{ $attributes->get('class', '') }} mt-4 w-full rounded-lg bg-primary-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 sm:mt-6 sm:w-auto"
      >
        Save changes
      </button>
    </form>
  ...
  <div class="{{ $attributes->get('class', '') }} mb-4 rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800 sm:p-6 xl:mb-0">
    <h2 class="{{ $attributes->get('class', '') }} mb-4 md:mb-6 text-xl font-bold text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-700 pb-4">Notifications</h2>
    <div class="{{ $attributes->get('class', '') }} mb-4 flex items-center justify-between">
      <h3 class="{{ $attributes->get('class', '') }} text-lg font-bold text-gray-900 dark:text-white">Alerts & Notifications</h3>
      <a href="#" class="{{ $attributes->get('class', '') }} text-base font-medium text-primary-700 hover:underline dark:text-primary-500">Select all</a>
    </div>
    <div class="{{ $attributes->get('class', '') }} mb-4 sm:mb-6">
      <label class="{{ $attributes->get('class', '') }} relative mb-4 flex cursor-pointer">
        ...
        ></div>
        <div class="{{ $attributes->get('class', '') }} ms-3">
          <span class="{{ $attributes->get('class', '') }} font-medium text-gray-900 dark:text-gray-300">Flowbite Communication</span>
          <p id="helper-toggle-text" class="{{ $attributes->get('class', '') }} text-sm font-normal text-gray-500 dark:text-gray-300">Get Flowbite news, announcements, and product updates</p>
        </div>
      </label>
      <label class="{{ $attributes->get('class', '') }} relative mb-4 flex cursor-pointer">
        <input type="checkbox" value="" class="{{ $attributes->get('class', '') }} peer sr-only" checked />
        <div
          class="{{ $attributes->get('class', '') }} peer h-6 w-11 shrink-0 rounded-full bg-gray-200 after:absolute after:start-[2px] after:top-[2px] after:h-5 after:w-5 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:bg-primary-600 peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 dark:border-gray-600 dark:bg-gray-700 dark:peer-focus:ring-primary-800 rtl:peer-checked:after:-translate-x-full"
        ></div>
        <div class="{{ $attributes->get('class', '') }} ms-3">
          <span class="{{ $attributes->get('class', '') }} font-medium text-gray-900 dark:text-gray-300">Account Activity</span>
          <p id="helper-toggle-text" class="{{ $attributes->get('class', '') }} text-sm font-normal text-gray-500 dark:text-gray-300">Get important notifications about you or activity you've missed</p>
        </div>
      </label>
      <label class="{{ $attributes->get('class', '') }} relative mb-4 flex cursor-pointer">
        <input type="checkbox" value="" class="{{ $attributes->get('class', '') }} peer sr-only" checked />
        ...
        ></div>
        <div class="{{ $attributes->get('class', '') }} ms-3">
          <span class="{{ $attributes->get('class', '') }} font-medium text-gray-900 dark:text-gray-300">Mobile push notifications</span>
          <p id="helper-toggle-text" class="{{ $attributes->get('class', '') }} text-sm font-normal text-gray-500 dark:text-gray-300">Receive push notifications whenever your company requires your attention</p>
        </div>
      </label>
      <label class="{{ $attributes->get('class', '') }} relative mb-4 flex cursor-pointer">
        <input type="checkbox" value="" class="{{ $attributes->get('class', '') }} peer sr-only" />
        ...
        ></div>
        <div class="{{ $attributes->get('class', '') }} ms-3">
          <span class="{{ $attributes->get('class', '') }} font-medium text-gray-900 dark:text-gray-300">Email notification</span>
          <p id="helper-toggle-text" class="{{ $attributes->get('class', '') }} text-sm font-normal text-gray-500 dark:text-gray-300">Receive email notifications whenever your company requires your attention</p>
        </div>
      </label>
      <label class="{{ $attributes->get('class', '') }} relative mb-4 flex cursor-pointer">
        <input type="checkbox" value="" class="{{ $attributes->get('class', '') }} peer sr-only" checked />
        ...
        ></div>
        <div class="{{ $attributes->get('class', '') }} ms-3">
          <span class="{{ $attributes->get('class', '') }} font-medium text-gray-900 dark:text-gray-300">Meetups near me</span>
          <p id="helper-toggle-text" class="{{ $attributes->get('class', '') }} text-sm font-normal text-gray-500 dark:text-gray-300">Get an email when a Flowbite Meetup is posted close to my location</p>
        </div>
      </label>
    </div>
    <div class="{{ $attributes->get('class', '') }} mb-4 flex items-center justify-between">
      <h3 class="{{ $attributes->get('class', '') }} text-lg font-bold text-gray-900 dark:text-white">Email me when:</h3>
      <a href="#" class="{{ $attributes->get('class', '') }} text-base font-medium text-primary-700 hover:underline dark:text-primary-500">Select all</a>
    </div>
    <div class="{{ $attributes->get('class', '') }} mb-4 sm:mb-6">
      <div class="{{ $attributes->get('class', '') }} mb-4 flex items-center">
        <input
          checked
          id="mention-checkbox"
          type="checkbox"
        ...
        />
        <label for="mention-checkbox" class="{{ $attributes->get('class', '') }} ms-2 text-sm font-medium text-gray-900 dark:text-white">Someone mentions me</label>
      </div>
      <div class="{{ $attributes->get('class', '') }} mb-4 flex items-center">
        <input
          checked
          ...
          class="{{ $attributes->get('class', '') }} h-4 w-4 rounded-sm border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600"
        />
        <label for="ask-checkbox" class="{{ $attributes->get('class', '') }} ms-2 text-sm font-medium text-gray-900 dark:text-white">Someone asks me to be a collaborator on one of their projects</label>
      </div>
      <div class="{{ $attributes->get('class', '') }} mb-4 flex items-center">
        <input
          ...
          class="{{ $attributes->get('class', '') }} h-4 w-4 rounded-sm border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600"
        />
        <label for="invitation-checkbox" class="{{ $attributes->get('class', '') }} ms-2 text-sm font-medium text-gray-900 dark:text-white">I receive invitations to invite new team members</label>
      </div>
      <div class="{{ $attributes->get('class', '') }} mb-4 flex items-center">
        <input
          id="follow-checkbox"
          ...
          class="{{ $attributes->get('class', '') }} h-4 w-4 rounded-sm border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600"
        />
        <label for="follow-checkbox" class="{{ $attributes->get('class', '') }} ms-2 text-sm font-medium text-gray-900 dark:text-white">Anyone follows me</label>
      </div>
      <div class="{{ $attributes->get('class', '') }} mb-4 flex items-center">
        <input
          ...
          class="{{ $attributes->get('class', '') }} h-4 w-4 rounded-sm border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600"
        />
        <label for="invitation-accept-checkbox" class="{{ $attributes->get('class', '') }} ms-2 text-sm font-medium text-gray-900 dark:text-white">Someone accepts my invitation</label>
      </div>
    </div>
    <div class="{{ $attributes->get('class', '') }} mb-4 flex items-center justify-between">
      <h3 class="{{ $attributes->get('class', '') }} text-lg font-bold text-gray-900 dark:text-white">Subscribe me to:</h3>
      <a href="#" class="{{ $attributes->get('class', '') }} text-base font-medium text-primary-700 hover:underline dark:text-primary-500">Select all</a>
    </div>
    <div class="{{ $attributes->get('class', '') }} mb-4 sm:mb-6">
      <div class="{{ $attributes->get('class', '') }} mb-4 flex">
        ...
        <div class="{{ $attributes->get('class', '') }} ms-2 text-sm">
          <label for="newsletter-checkbox" class="{{ $attributes->get('class', '') }} font-medium text-gray-900 dark:text-gray-300">Weekly newsletter</label>
          <p id="newsletter-checkbox-helper" class="{{ $attributes->get('class', '') }} text-sm font-normal text-gray-500 dark:text-gray-400">Get the latest news for Flowbite and Tailwind CSS</p>
        </div>
      </div>
      <div class="{{ $attributes->get('class', '') }} mb-4 flex">
        <div class="{{ $attributes->get('class', '') }} flex h-5 items-center">
        ...
        <div class="{{ $attributes->get('class', '') }} ms-2 text-sm">
          <label for="products-checkbox" class="{{ $attributes->get('class', '') }} font-medium text-gray-900 dark:text-gray-300">Products</label>
          <p id="products-checkbox-helper" class="{{ $attributes->get('class', '') }} text-sm font-normal text-gray-500 dark:text-gray-400">Get notified when a product has been updated or launched</p>
        </div>
      </div>
      <div class="{{ $attributes->get('class', '') }} mb-4 flex">
        <div class="{{ $attributes->get('class', '') }} flex h-5 items-center">
        ...
        <div class="{{ $attributes->get('class', '') }} ms-2 text-sm">
          <label for="community-checkbox" class="{{ $attributes->get('class', '') }} font-medium text-gray-900 dark:text-gray-300">Flowbite community</label>
          <p id="community-checkbox-helper" class="{{ $attributes->get('class', '') }} text-sm font-normal text-gray-500 dark:text-gray-400">Monday: Latest design news & community highlights</p>
        </div>
      </div>
      <div class="{{ $attributes->get('class', '') }} mb-4 flex">
        <div class="{{ $attributes->get('class', '') }} flex h-5 items-center">
        ...
        <div class="{{ $attributes->get('class', '') }} ms-2 text-sm">
          <label for="jobs-checkbox" class="{{ $attributes->get('class', '') }} font-medium text-gray-900 dark:text-gray-300">Flowbite jobs</label>
          <p id="jobs-checkbox-helper" class="{{ $attributes->get('class', '') }} text-sm font-normal text-gray-500 dark:text-gray-400">Friday: New career and freelance project opportunities</p>
        </div>
      </div>
    </div>
    <button
      type="button"
      class="{{ $attributes->get('class', '') }} w-full rounded-lg bg-primary-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 sm:w-auto"
    >
      Save changes
    </button>
  </div>
  <div class="{{ $attributes->get('class', '') }} col-span-2 mb-4 rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800 sm:p-6 xl:mb-0">
    <h2 class="{{ $attributes->get('class', '') }} mb-4 md:mb-6 text-xl font-bold text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-700 pb-4">General information</h2>
    <form action="#">
      <div class="{{ $attributes->get('class', '') }} mb-4 grid gap-4 sm:mb-6 sm:grid-cols-2 md:grid-cols-3">
        <div class="{{ $attributes->get('class', '') }} col-span-1 space-y-4">
          <div>
            <label for="name" class="{{ $attributes->get('class', '') }} mb-2 flex text-sm font-medium text-gray-900 dark:text-white">Your name*</label>
            <input
              type="text"
              name="name"
              id="fullname"
          ...
          <div>
            <label for="zip" class="{{ $attributes->get('class', '') }} mb-2 flex text-sm font-medium text-gray-900 dark:text-white">ZIP/Postal code</label>
            <input
              type="number"
              name="zip"
              id="zip"
          ...
          <div>
            <label for="country" class="{{ $attributes->get('class', '') }} mb-2 flex text-sm font-medium text-gray-900 dark:text-white">Country*</label>
            <input
              type="text"
              name="country"
              id="country"
          ...
          <div>
            <label for="city" class="{{ $attributes->get('class', '') }} mb-2 flex text-sm font-medium text-gray-900 dark:text-white">Town/City*</label>
            <input
              type="text"
              name="city"
              id="city"
        ...
        <div class="{{ $attributes->get('class', '') }} col-span-1 space-y-4">
          <div>
            <label for="address" class="{{ $attributes->get('class', '') }} mb-2 flex text-sm font-medium text-gray-900 dark:text-white">Full address*</label>
            <input
              type="text"
              name="address"
              id="address"
          ...
          <div>
            <label for="organization" class="{{ $attributes->get('class', '') }} mb-2 flex text-sm font-medium text-gray-900 dark:text-white">Your organization</label>
            <input
              type="text"
              name="organization"
              id="organization"
          ...
          <div>
            <label for="department" class="{{ $attributes->get('class', '') }} mb-2 flex text-sm font-medium text-gray-900 dark:text-white">Department</label>
            <input
              type="text"
              name="department"
              id="department"
          ...
          <div>
            <label for="account-type" class="{{ $attributes->get('class', '') }} mb-2 flex items-center text-sm font-medium text-gray-900 dark:text-white"
              >Account Type<button data-tooltip-target="tooltip-account-type-description" class="{{ $attributes->get('class', '') }} ms-1 text-gray-400 hover:text-gray-900 dark:hover:text-white" type="button">
                <svg class="{{ $attributes->get('class', '') }} h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                  <path
                    fill-rule="evenodd"
                    d="M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12Zm9.008-3.018a1.502 1.502 0 0 1 2.522 1.159v.024a1.44 1.44 0 0 1-1.493 1.418 1 1 0 0 0-1.037.999V14a1 1 0 1 0 2 0v-.539a3.44 3.44 0 0 0 2.529-3.256 3.502 3.502 0 0 0-7-.255 1 1 0 0 0 2 .076c.014-.398.187-.774.48-1.044Zm.982 7.026a1 1 0 1 0 0 2H12a1 1 0 1 0 0-2h-.01Z"
        ...
        <div class="{{ $attributes->get('class', '') }} col-span-1 sm:col-span-2 md:col-span-1">
          <label for="message" class="{{ $attributes->get('class', '') }} mb-2 block text-sm font-medium text-gray-900 dark:text-white">Biography</label>
          <textarea
            id="message"
            rows="14"
            class="{{ $attributes->get('class', '') }} block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500"
  ...
  <div class="{{ $attributes->get('class', '') }} col-span-2 mb-4 rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800 sm:p-6 xl:mb-0">
    <h2 class="{{ $attributes->get('class', '') }} mb-4 md:mb-6 text-xl font-bold text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-700 pb-4">Social</h2>
    <form action="#">
      <div class="{{ $attributes->get('class', '') }} mb-4 grid gap-4 sm:mb-6 sm:grid-cols-2">
        <div>
          <label for="facebook" class="{{ $attributes->get('class', '') }} mb-2 flex text-sm font-medium text-gray-900 dark:text-white">Facebook</label>
          <input
            type="text"
            name="facebook"
            id="facebook"
        ...
        <div>
          <label for="dribbble" class="{{ $attributes->get('class', '') }} mb-2 flex text-sm font-medium text-gray-900 dark:text-white">Dribbble</label>
          <input
            type="text"
            name="dribbble"
            id="dribbble"
        ...
        <div>
          <label for="twitter" class="{{ $attributes->get('class', '') }} mb-2 flex text-sm font-medium text-gray-900 dark:text-white">Twitter</label>
          <input
            type="text"
            name="twitter"
            id="twitter"
        ...
        <div>
          <label for="behance" class="{{ $attributes->get('class', '') }} mb-2 flex text-sm font-medium text-gray-900 dark:text-white">Behance</label>
          <input
            type="text"
            name="behance"
            id="behance"
        ...
        <div>
          <label for="github" class="{{ $attributes->get('class', '') }} mb-2 flex text-sm font-medium text-gray-900 dark:text-white">Github</label>
          <input
            type="text"
            name="github"
            id="github"
        ...
        <div>
          <label for="pinterest" class="{{ $attributes->get('class', '') }} mb-2 flex text-sm font-medium text-gray-900 dark:text-white">Pinterest</label>
          <input
            type="text"
            name="pinterest"
            id="pinterest"
        ...
        <div>
          <label for="instagram" class="{{ $attributes->get('class', '') }} mb-2 flex text-sm font-medium text-gray-900 dark:text-white">Instagram</label>
          <input
            type="text"
            name="instagram"
            id="instagram"
        ...
        <div>
          <label for="tiktok" class="{{ $attributes->get('class', '') }} mb-2 flex text-sm font-medium text-gray-900 dark:text-white">TikTok</label>
          <input
            type="text"
            name="tiktok"
            id="tiktok"
  ...
  <div class="{{ $attributes->get('class', '') }} col-span-2 rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800 sm:p-6">
    <h2 class="{{ $attributes->get('class', '') }} mb-4 md:mb-6 text-xl font-bold text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-700 pb-4">Password</h2>
    <form action="#">
      <div class="{{ $attributes->get('class', '') }} mb-4 grid gap-4 sm:mb-6 sm:grid-cols-2">
        <div class="{{ $attributes->get('class', '') }} col-span-1 space-y-4">
          <div>
            <label for="current-password" class="{{ $attributes->get('class', '') }} mb-2 flex text-sm font-medium text-gray-900 dark:text-white">Current password</label>
            <input
              type="password"
          ...
          <div>
            <label for="new-password" class="{{ $attributes->get('class', '') }} mb-2 flex text-sm font-medium text-gray-900 dark:text-white">Your new password</label>
            <input
              type="password"
              name="new-password"
              id="new-password"
          ...
          <div>
            <label for="confirm-password" class="{{ $attributes->get('class', '') }} mb-2 flex text-sm font-medium text-gray-900 dark:text-white">Confirm new password</label>
            <input
              type="password"
        ...
        <div class="{{ $attributes->get('class', '') }} col-span-1 rounded-lg bg-gray-50 p-4 dark:bg-gray-700">
          <h3 class="{{ $attributes->get('class', '') }} mb-1 text-sm font-medium text-gray-900 dark:text-white">Password requirements:</h3>
          <p class="{{ $attributes->get('class', '') }} mb-4 text-sm font-normal text-gray-500 dark:text-gray-400">Ensure that these requirements are met:</p>
          <ul class="{{ $attributes->get('class', '') }} space-y-2 text-sm text-gray-500 dark:text-gray-400">
            <li class="{{ $attributes->get('class', '') }} flex items-center">
              <svg class="{{ $attributes->get('class', '') }} me-2 h-4 w-4 shrink-0 text-green-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
            ...
            <li class="{{ $attributes->get('class', '') }} flex items-center">
              <svg class="{{ $attributes->get('class', '') }} me-2 h-4 w-4 shrink-0 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                <path
                  fill-rule="evenodd"
