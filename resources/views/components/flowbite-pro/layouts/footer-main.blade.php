...
<footer class="{{ $attributes->get('class', '') }} bg-white dark:bg-gray-900">
  <div class="{{ $attributes->get('class', '') }} mx-auto max-w-screen-xl p-4 py-6 sm:py-16 md:p-8 lg:p-10 lg:py-24">
    <div class="{{ $attributes->get('class', '') }} grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-5">
      <div>
        <h2 class="{{ $attributes->get('class', '') }} mb-6 text-sm font-semibold uppercase text-gray-900 dark:text-white">Company</h2>
        <ul class="{{ $attributes->get('class', '') }} text-gray-500 dark:text-gray-400">
          <li class="{{ $attributes->get('class', '') }} mb-4">
            <a href="#" class="{{ $attributes->get('class', '') }}  hover:underline">About</a>
          </li>
          <li class="{{ $attributes->get('class', '') }} mb-4">
            <a href="#" class="{{ $attributes->get('class', '') }} hover:underline">Careers</a>
          </li>
          <li class="{{ $attributes->get('class', '') }} mb-4">
            <a href="#" class="{{ $attributes->get('class', '') }} hover:underline">Brand Center</a>
          </li>
          <li class="{{ $attributes->get('class', '') }} mb-4">
            <a href="#" class="{{ $attributes->get('class', '') }} hover:underline">Blog</a>
          </li>
        </ul>
      </div>
      <div>
        <h2 class="{{ $attributes->get('class', '') }} mb-6 text-sm font-semibold uppercase text-gray-900 dark:text-white">Help center</h2>
        <ul class="{{ $attributes->get('class', '') }} text-gray-500 dark:text-gray-400">
          <li class="{{ $attributes->get('class', '') }} mb-4">
            <a href="#" class="{{ $attributes->get('class', '') }} hover:underline">Discord Server</a>
          </li>
          <li class="{{ $attributes->get('class', '') }} mb-4">
            <a href="#" class="{{ $attributes->get('class', '') }} hover:underline">Twitter</a>
          </li>
          <li class="{{ $attributes->get('class', '') }} mb-4">
            <a href="#" class="{{ $attributes->get('class', '') }} hover:underline">Facebook</a>
          </li>
          <li class="{{ $attributes->get('class', '') }} mb-4">
            <a href="#" class="{{ $attributes->get('class', '') }} hover:underline">Contact Us</a>
          </li>
        </ul>
      </div>
      <div>
        <h2 class="{{ $attributes->get('class', '') }} mb-6 text-sm font-semibold uppercase text-gray-900 dark:text-white">Legal</h2>
        <ul class="{{ $attributes->get('class', '') }} text-gray-500 dark:text-gray-400">
          <li class="{{ $attributes->get('class', '') }} mb-4">
            <a href="#" class="{{ $attributes->get('class', '') }} hover:underline">Privacy Policy</a>
          </li>
          <li class="{{ $attributes->get('class', '') }} mb-4">
            <a href="#" class="{{ $attributes->get('class', '') }} hover:underline">Licensing</a>
          </li>
          <li class="{{ $attributes->get('class', '') }} mb-4">
            <a href="#" class="{{ $attributes->get('class', '') }} hover:underline">Terms</a>
          </li>
        </ul>
      </div>
      <div>
      ...
      <div>
        <h2 class="{{ $attributes->get('class', '') }} mb-6 text-sm font-semibold uppercase text-gray-900 dark:text-white">Download</h2>
        <ul class="{{ $attributes->get('class', '') }} text-gray-500 dark:text-gray-400">
          <li class="{{ $attributes->get('class', '') }} mb-4">
            <a href="#" class="{{ $attributes->get('class', '') }} hover:underline">iOS</a>
          </li>
          <li class="{{ $attributes->get('class', '') }} mb-4">
            <a href="#" class="{{ $attributes->get('class', '') }} hover:underline">Android</a>
          </li>
          <li class="{{ $attributes->get('class', '') }} mb-4">
            <a href="#" class="{{ $attributes->get('class', '') }} hover:underline">Windows</a>
          </li>
          <li class="{{ $attributes->get('class', '') }} mb-4">
            <a href="#" class="{{ $attributes->get('class', '') }} hover:underline">MacOS</a>
          </li>
        </ul>
      </div>
    </div>
    <hr class="{{ $attributes->get('class', '') }} my-6 border-gray-200 dark:border-gray-700 sm:mx-auto lg:my-8" />
    <div class="{{ $attributes->get('class', '') }} text-center">
      <a href="#" class="{{ $attributes->get('class', '') }} mb-5 flex items-center justify-center text-2xl font-semibold text-gray-900 dark:text-white">
        <svg class="{{ $attributes->get('class', '') }} mr-2 h-8" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <span class="{{ $attributes->get('class', '') }} block text-center text-sm text-gray-500 dark:text-gray-400">© 2021-2025 <a href="#" class="{{ $attributes->get('class', '') }} hover:underline">Flowbite™</a>. All Rights Reserved. </span>
      <ul class="{{ $attributes->get('class', '') }} mt-5 flex justify-center space-x-5">
        <li>
          <a href="#" class="{{ $attributes->get('class', '') }} text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
