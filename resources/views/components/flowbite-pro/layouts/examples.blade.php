...
<!doctype html>
<html @{{  if eq .Page.Params.direction "rtl"  }}lang="ar" dir="rtl"@{{  else  }}lang="en"@{{  end  }}@{{  with .Page.Params.html_class  }}class="{{ $attributes->get('class', '') }} @{{  .  }}"@{{  end  }}>
  <head>
  ...
  <body @{{  with .Page.Params.body_class  }}class="{{ $attributes->get('class', '') }} @{{  .  }}"@{{  end  }}>
    @{{  .Content  }}
  </body>
</html>
