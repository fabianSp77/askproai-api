{{-- Flowbite Component: list --}}
@props(['title' => 'Tailwind CSS Users Page - Flowbite', 'description' => 'Get started with a premium admin dashboard interface built with Tailwind CSS and Flowbite featuring over 50 example pages of charts, calendars, kanban boards, dashboards, CRUD pages, mailing systems, and more.'])
          ...
          <tr class="border-b hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-gray-800 border-gray-200">
            ...
            <th scope="row" class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">
              <div class="mr-3 flex items-center">
                <img src="/images/users/avatar-10.png" alt="User avatar" class="mr-3 h-8 w-auto rounded-full" />
  ...
  <div class="relative max-h-full w-full max-w-3xl p-4">
    ...
    <div class="relative rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800 sm:p-5">
      ...
      <div class="mb-4 flex justify-between rounded-t sm:mb-5">
        <div class="flex items-center">
          <img class="mr-2 h-12 w-12 rounded-full sm:mr-4" src="/images/users/helene-engels.png" alt="Helene avatar" />
          <div>
