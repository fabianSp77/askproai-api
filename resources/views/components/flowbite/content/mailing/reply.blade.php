{{-- Flowbite Component: reply --}}
@props(['title' => 'Tailwind CSS Reply Page - Flowbite', 'description' => 'Get started with a premium admin dashboard interface built with Tailwind CSS and Flowbite featuring over 50 example pages of charts, calendars, kanban boards, dashboards, CRUD pages, mailing systems, and more.'])
...
<div class="p-4 xl:p-8">
  <div class="mb-4 items-center justify-between border-b border-gray-200 pb-4 dark:border-gray-800">
    <div class="mb-4 flex items-center justify-between gap-4 border-b border-gray-200 pb-4 dark:border-gray-800">
      <h2 class="text-base font-medium text-gray-900 dark:text-white sm:mb-1.5 sm:flex sm:text-xl sm:leading-none">
        RE: Inquiry about design services <span class="me-2 ms-3 hidden rounded-sm bg-yellow-100 px-2.5 py-0.5 text-xs font-medium text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300 sm:flex">External</span>
      </h2>
  ...
  <form class="mt-6 rounded-lg border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800">
    <div class="w-full">
      <div class="flex items-center justify-between px-4 py-3">
        <div class="flex items-center space-x-2">
          ...
          <!-- Dropdown menu -->
          <div id="messageDropdown" class="z-10 hidden w-36 rounded-lg bg-white p-2 shadow-sm dark:bg-gray-700">
          ...
          <p class="text-sm text-gray-500 dark:text-gray-400">Joseph McFallen (name@example.com)</p>
        </div>
      ...
      <div class="rounded-b-lg bg-white px-4 py-2 dark:bg-gray-800">
        ...
        <textarea id="editor" rows="8" autofocus class="block w-full border-0 bg-white px-0 text-sm text-gray-800 focus:ring-0 dark:bg-gray-800 dark:text-white dark:placeholder-gray-400" placeholder="" required></textarea>
      </div>
    </div>
    <div class="flex flex-wrap items-center divide-gray-200 rounded-b-lg border-t border-gray-200 px-4 py-3 dark:divide-gray-700 dark:border-gray-700 sm:divide-x sm:rtl:divide-x-reverse">
      <div class="flex flex-wrap items-center space-x-0.5 sm:pe-4 rtl:space-x-reverse">
        ...
        <!-- Dropdown menu -->
        <div id="filterDropdown" class="z-10 hidden w-56 rounded-lg bg-white p-2 shadow-sm dark:bg-gray-700">
        ...
        <div id="tooltip-font-italic" role="tooltip" class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-xs transition-opacity duration-300 dark:bg-gray-700">
          Italic
          <div class="tooltip-arrow" data-popper-arrow></div>
        </div>
        <a
      ...
      <div class="hidden flex-wrap items-center space-x-1 sm:ps-4 md:flex rtl:space-x-reverse">
        ...
        <div id="tooltip-text-center" role="tooltip" class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-xs transition-opacity duration-300 dark:bg-gray-700">
          Text center
          <div class="tooltip-arrow" data-popper-arrow></div>
        </div>
        <a
        ...
        <div id="tooltip-ordered-list" role="tooltip" class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-xs transition-opacity duration-300 dark:bg-gray-700">
          Ordered list
          <div class="tooltip-arrow" data-popper-arrow></div>
        </div>
        ...
        <div id="tooltip-text-indent" role="tooltip" class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-xs transition-opacity duration-300 dark:bg-gray-700">
          Text indent
          <div class="tooltip-arrow" data-popper-arrow></div>
        </div>
        <a
        ...
        <div id="tooltip-text-outdent" role="tooltip" class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-xs transition-opacity duration-300 dark:bg-gray-700">
          Text outdent
          <div class="tooltip-arrow" data-popper-arrow></div>
        </div>
      </div>
    ...
    <div class="items-center space-x-0.5 rounded-b-lg border-t border-gray-200 px-4 py-3 dark:border-gray-700 sm:flex">
      ...
      <a href="#" data-tooltip-target="tooltip-signature" class="inline-flex cursor-pointer justify-center rounded-lg p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white">
        <svg class="h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
          <path
            fill-rule="evenodd"
