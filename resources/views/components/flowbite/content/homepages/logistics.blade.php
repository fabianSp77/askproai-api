{{-- Flowbite Component: logistics --}}
@props(['title' => 'Tailwind CSS Logistics Dashboard - Flowbite', 'description' => 'Get started with a premium admin dashboard interface built with Tailwind CSS and Flowbite featuring over 50 example pages of charts, calendars, kanban boards, dashboards, CRUD pages, mailing systems, and more.'])
...
<div class="px-4">
  ...
  <div class="mb-4 rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800 md:p-6">
    <div class="justify-between sm:mb-4 sm:flex">
      <div class="mb-4 sm:mb-0">
        <h2 class="mb-2 pe-1 text-xl font-bold leading-none text-gray-900 dark:text-white">Orders by countries</h2>
        <p class="text-gray-500 dark:text-gray-400">Total orders by countries around the world</p>
      </div>
      <div>
        <button
        ...
        <!-- Dropdown menu -->
        <div class="z-50 my-4 hidden list-none w-80 divide-y divide-gray-100 rounded-lg bg-white text-sm font-medium shadow-sm dark:divide-gray-600 dark:bg-gray-700" id="ordersActionsDropdown">
    ...
    <div class="items-center lg:flex lg:space-x-6">
      <div class="my-4 w-full lg:my-0" id="map-orders"></div>
      <!-- Table -->
      <div class="relative mb-4 w-full overflow-x-auto md:mb-6">
        <table class="w-full text-left text-sm text-gray-500 dark:text-gray-400 rtl:text-right">
          <thead class="bg-gray-50 text-xs uppercase text-gray-500 dark:bg-gray-700 dark:text-gray-400">
            <tr>
              <th scope="col" class="flex w-48 rounded-s-lg px-6 py-3 font-semibold">Country</th>
              <th scope="col" class="px-6 py-3 font-semibold">Orders</th>
              <th scope="col" class="px-6 py-3 font-semibold">Customers</th>
              <th scope="col" class="flex w-36 rounded-e-lg px-6 py-3 font-semibold">Delivery rate</th>
            </tr>
          </thead>
          <tbody>
            ...
            <tr class="border-b border-gray-100 bg-white dark:border-gray-700 dark:bg-gray-800">
              <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">Canada</td>
              <td class="px-6 py-4">
                <div class="flex items-center">
                  <svg class="h-5 w-5 text-green-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v13m0-13 4 4m-4-4-4 4" />
            ...
            <tr class="border-b border-gray-100 bg-white dark:border-gray-700 dark:bg-gray-800">
              <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">United Kingdom</td>
              <td class="px-6 py-4">
                <div class="flex items-center">
                  <svg class="h-5 w-5 text-green-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v13m0-13 4 4m-4-4-4 4" />
            ...
            <tr class="border-b border-gray-100 bg-white dark:border-gray-700 dark:bg-gray-800">
              <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">Spain</td>
              <td class="px-6 py-4">
                <div class="flex items-center">
                  <svg class="h-5 w-5 text-red-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19V5m0 14-4-4m4 4 4-4" />
  ...
  <div class="rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800 md:p-6">
    <div class="justify-between sm:mb-4 sm:flex">
      <div class="mb-4 sm:mb-0">
        <h2 class="mb-2 pe-1 text-xl font-bold leading-none text-gray-900 dark:text-white">Inventory level <span class="ms-2 font-semibold text-green-500">+1,452 (9,85%)</span></h2>
        <p class="text-gray-500 dark:text-gray-400">Material stock</p>
      </div>
      <div>
        <button
        ...
        <!-- Dropdown menu -->
        <div class="z-50 my-4 hidden list-none w-80 divide-y divide-gray-100 rounded-lg bg-white text-sm font-medium shadow-sm dark:divide-gray-600 dark:bg-gray-700" id="inventoryActionsDropdown">
          <ul class="p-2 text-gray-500 dark:text-gray-400" role="none" aria-labelledby="referrersActionsDropdown">
            <li>
              <button type="button" class="inline-flex w-full items-center rounded-md px-3 py-2 hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Yesterday</button>
            </li>
  ...
  <div class="my-4 grid grid-cols-1 gap-4 2xl:grid-cols-3">
    <div class="rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800 md:p-6">
      <div class="mb-4 flex justify-between">
        <div>
          <h2 class="mb-1 text-xl font-bold text-gray-900 dark:text-white">Total trucks on the road</h2>
          <button type="button" data-dropdown-toggle="language-dropdown" class="inline-flex items-center font-medium leading-none text-primary-700 hover:underline dark:text-primary-500">
          ...
          <!-- Dropdown -->
          <div class="z-50 my-4 hidden w-44 list-none divide-y divide-gray-100 rounded-lg bg-white shadow-sm dark:bg-gray-700" id="language-dropdown">
            <ul class="p-2 font-medium text-gray-500 dark:text-gray-400" role="none">
              <li>
                <button type="button" class="inline-flex items-center w-full rounded-md px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">
              ...
              <li>
                <button type="button" class="inline-flex items-center w-full rounded-md px-4 py-2 text-sm hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">
      ...
      <div class="grid grid-cols-1 items-center justify-between border-t border-gray-200 dark:border-gray-700">
        <div class="flex items-center justify-between pt-5">
          ...
          <!-- Dropdown menu -->
          <div id="totalTrucksDropdown" class="z-10 hidden w-44 divide-y divide-gray-100 rounded-lg bg-white shadow-sm dark:bg-gray-700">
    ...
    <div class="rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800 md:p-6">
      <div class="mb-4 flex items-start justify-between">
        <div>
          <h2 class="mb-1 text-xl font-bold text-gray-900 dark:text-white">576,235</h2>
        ...
        <!-- Dropdown menu -->
        <div class="z-50 my-4 hidden list-none w-80 divide-y divide-gray-100 rounded-lg bg-white text-sm font-medium shadow-sm dark:divide-gray-600 dark:bg-gray-700" id="totalDeliveriesDropdown">
          <ul class="p-2 text-gray-500 dark:text-gray-400" role="none" aria-labelledby="totalDeliveriesDropdownButton">
            <li>
              <button type="button" class="inline-flex w-full items-center rounded-md px-3 py-2 hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Yesterday</button>
            </li>
            <li>
      ...
      <div class="grid grid-cols-1 items-center justify-between border-t border-gray-200 dark:border-gray-700">
        <div class="flex items-center justify-between pt-5">
          ...
          <!-- Dropdown menu -->
          <div id="totalDeliveriesDropdown2" class="z-10 hidden w-44 divide-y divide-gray-100 rounded-lg bg-white shadow-sm dark:bg-gray-700">
            <ul class="p-2 text-sm font-medium text-gray-500 dark:text-gray-400" aria-labelledby="totalTrucksButton">
              <li>
                <button type="button" class="inline-flex w-full items-center rounded-md px-3 py-2 hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white">Yesterday</button>
              </li>
    ...
    <div class="rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800 md:p-6">
      ...
      <div class="mb-4 grid grid-cols-2 md:mb-6">
        <dl class="flex items-center">
          <dt class="me-1 shrink-0 text-sm text-gray-500 dark:text-gray-400">Delivered shipments:</dt>
          <dd class="text-sm font-semibold text-gray-900 dark:text-white">3,423</dd>
        </dl>
        <dl class="flex items-center justify-end">
          <dt class="me-1 text-sm text-gray-500 dark:text-gray-400">Countries:</dt>
          <dd class="text-sm font-semibold text-gray-900 dark:text-white">22</dd>
        </dl>
      </div>
      <div class="mb-4" id="delivered-shipments-chart"></div>
