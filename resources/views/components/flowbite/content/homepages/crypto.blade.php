{{-- Flowbite Component: crypto --}}
@props(['title' => 'Tailwind CSS Crypto Dashboard - Flowbite', 'description' => 'Get started with a premium admin dashboard interface built with Tailwind CSS and Flowbite featuring over 50 example pages of charts, calendars, kanban boards, dashboards, CRUD pages, mailing systems, and more.'])
      ...
      <ul>
        ...
        <li class="border-b border-gray-200 py-4 dark:border-gray-700">
          <div class="items-center space-y-3 sm:flex sm:space-x-4 sm:space-y-0">
            ...
            <div class="flex items-center justify-between sm:block">
              <p class="font-semibold text-gray-900 dark:text-white">+5.2253 EGLD</p>
