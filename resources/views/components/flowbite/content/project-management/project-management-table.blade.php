{{-- Flowbite Component: project-management-table --}}
@props(['title' => '', 'description' => ''])
<div {{ $attributes->merge(['class' => '']) }}>
<section class="bg-gray-50 dark:bg-gray-900 py-3 sm:py-5"></section>
    <div class="mx-auto max-w-screen-2xl px-4 lg:px-12">
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div class="border-b dark:border-gray-700 border-gray-200 mx-4">
                ...
                <div class="flex flex-col-reverse md:flex-row items-center justify-between md:space-x-4 py-3">
                    <div class="w-full lg:w-2/3 flex flex-col space-y-3 md:space-y-0 md:flex-row md:items-center">
                        ...
                        <div class="flex items-center space-x-4">
                            <div>
                                ...
                                <div id="filterDropdown" class="z-10 hidden p-3 bg-white rounded-lg shadow-sm w-56 dark:bg-gray-700">
                                    ...
                                    <ul class="space-y-2 text-sm" aria-labelledby="filterDropdownButton">
                                        <li>
                                            <label class="flex items-center text-sm font-medium text-gray-900 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-md px-1.5 py-1 w-full">
                                                <input type="checkbox" value="" class="w-4 h-4 mr-2 bg-gray-100 border-gray-300 rounded-sm text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                                In progress
                                            </label>
                                        </li>
                                        <li>
                                            <label class="flex items-center text-sm font-medium text-gray-900 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-md px-1.5 py-1 w-full">
                                                <input type="checkbox" value="" checked="" class="w-4 h-4 mr-2 bg-gray-100 border-gray-300 rounded-sm text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                                In review
                                            </label>
                                        </li>
                                        <li>
                            ...
                            <div>
                                ...
                                <div id="configurationDropdown" class="hidden z-10 w-44 bg-white rounded-sm divide-y divide-gray-100 shadow-sm dark:bg-gray-700 dark:divide-gray-600">
                    ...
                    <div class="w-full md:w-auto flex flex-col md:flex-row mb-3 md:mb-0 items-stretch md:items-center justify-end md:space-x-3 shrink-0">
                        ...
                        <tr>
                            <th scope="col" class="p-4">
                                <div class="flex items-center">
                                    <input id="checkbox-all" type="checkbox" class="w-4 h-4 text-primary-600 bg-gray-100 rounded-sm border-gray-300 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="checkbox-all" class="sr-only">checkbox</label>
                                </div>
                            </th>
                            <th scope="col" class="px-4 py-3 whitespace-nowrap">Task</th>
                            <th scope="col" class="px-4 py-3 whitespace-nowrap">Status</th>
                            <th scope="col" class="px-4 py-3 whitespace-nowrap">Users</th>
                            <th scope="col" class="px-4 py-3 min-w-[14rem]">Progress</th>
                            <th scope="col" class="px-4 py-3 whitespace-nowrap">Preview</th>
                            <th scope="col" class="px-4 py-3 whitespace-nowrap">Time Tracking</th>
                    ...
                    <tbody>
                        <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                            <td class="px-4 py-2 w-4">
                                <div class="flex items-center">
                                    <input id="checkbox-table-search-1" type="checkbox" onclick="event.stopPropagation()" class="w-4 h-4 text-primary-600 bg-gray-100 rounded-sm border-gray-300 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            ...
                            <td class="px-4 py-2 whitespace-nowrap">
                                <span class="bg-primary-100 text-primary-800 text-xs font-medium px-2.5 py-0.5 rounded-sm dark:bg-primary-900 dark:text-primary-300">In progress</span>
                            </td>
                            <td class="px-4 py-2 whitespace-nowrap">
                                <div class="flex -space-x-4 w-28">
                                    <img src="/images/users/avatar-10.png" alt="" class="w-10 h-10 shrink-0 border-2 border-white rounded-full dark:border-gray-800">
                                    <img src="/images/users/avatar-1.png" alt="" class="w-10 h-10 shrink-0 border-2 border-white rounded-full dark:border-gray-800">
                                    <img src="/images/users/avatar-3.png" alt="" class="w-10 h-10 shrink-0 border-2 border-white rounded-full dark:border-gray-800">
                                    <a href="#" class="shrink-0 flex items-center justify-center w-10 h-10 text-xs font-medium text-white bg-gray-900 dark:bg-gray-700 border-2 border-white rounded-full hover:bg-gray-600 dark:border-gray-800">+5</a>
                                </div>
                            </td>
                            ...
                            <td class="px-4 py-2 whitespace-nowrap font-medium text-gray-900 dark:text-white text-xs">23 Nov 2025</td>
                            <td class="px-4 py-2">
                                ...
                                <div id="-dropdown" class="hidden z-10 w-44 bg-white rounded-sm divide-y divide-gray-100 shadow-sm dark:bg-gray-700 dark:divide-gray-600">
                        ...
                        <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <td class="px-4 py-2 whitespace-nowrap">
                                <span class="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-sm dark:bg-green-900 dark:text-green-300">Completed</span>
                            </td>
                            <td class="px-4 py-2 whitespace-nowrap">
                                <div class="flex -space-x-4 w-28">
                                    <img src="/images/users/avatar-6.png" alt="" class="w-10 h-10 shrink-0 border-2 border-white rounded-full dark:border-gray-800">
                                    <img src="/images/users/avatar-7.png" alt="" class="w-10 h-10 shrink-0 border-2 border-white rounded-full dark:border-gray-800">
                                    <img src="/images/users/avatar-2.png" alt="" class="w-10 h-10 shrink-0 border-2 border-white rounded-full dark:border-gray-800">
                                    <a href="#" class="shrink-0 flex items-center justify-center w-10 h-10 text-xs font-medium text-white bg-gray-900 dark:bg-gray-700 border-2 border-white rounded-full hover:bg-gray-600 dark:border-gray-800">+2</a>
                                </div>
                            </td>
                            <td class="px-4 py-2 font-medium whitespace-nowrap">
                                <div class="flex justify-end mb-1">
                            ...
                            <td class="px-4 py-2 whitespace-nowrap font-medium text-gray-900 dark:text-white text-xs">03 Nov 2025</td>
                            <td class="px-4 py-2">
                                <button id="-dropdown-button" type="button" data-dropdown-toggle="-dropdown" class="inline-flex items-center p-1 text-sm font-medium text-center text-gray-500 hover:text-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100">
                                    <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                        ...
                        <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <td class="px-4 py-2 whitespace-nowrap">
                                <div class="flex -space-x-4 w-28">
                                    <img src="/images/users/avatar-8.png" alt="" class="w-10 h-10 shrink-0 border-2 border-white rounded-full dark:border-gray-800">
                                    <img src="/images/users/avatar-1.png" alt="" class="w-10 h-10 shrink-0 border-2 border-white rounded-full dark:border-gray-800">
                                    <img src="/images/users/avatar-3.png" alt="" class="w-10 h-10 shrink-0 border-2 border-white rounded-full dark:border-gray-800">
                                </div>
                            </td>
                        ...
                        <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <td class="px-4 py-2 whitespace-nowrap">
                                <div class="flex -space-x-4 w-28">
                                    <img src="/images/users/avatar-2.png" alt="" class="w-10 h-10 shrink-0 border-2 border-white rounded-full dark:border-gray-800">
                                    <img src="/images/users/avatar-1.png" alt="" class="w-10 h-10 shrink-0 border-2 border-white rounded-full dark:border-gray-800">
                                    <img src="/images/users/avatar-5.png" alt="" class="w-10 h-10 shrink-0 border-2 border-white rounded-full dark:border-gray-800">
                                </div>
                            </td>
                            <td class="px-4 py-2 font-medium whitespace-nowrap">
                                <div class="flex justify-end mb-1">
                        ...
                        <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <td class="px-4 py-2 whitespace-nowrap font-medium text-gray-900 dark:text-white text-xs">23 Oct 2025</td>
                            <td class="px-4 py-2">
                                <button id="-dropdown-button" type="button" data-dropdown-toggle="-dropdown" class="inline-flex items-center p-1 text-sm font-medium text-center text-gray-500 hover:text-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100">
                                    <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                        ...
                        <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <td class="px-4 py-2 whitespace-nowrap">
                                <span class="bg-yellow-100 text-yellow-800 text-xs font-medium px-2.5 py-0.5 rounded-sm dark:bg-yellow-900 dark:text-yellow-300">In review</span>
                            </td>
                            <td class="px-4 py-2 whitespace-nowrap">
                                <div class="flex -space-x-4 w-28">
                                    <img src="/images/users/avatar-10.png" alt="" class="w-10 h-10 shrink-0 border-2 border-white rounded-full dark:border-gray-800">
                            ...
                            <td class="px-4 py-2 whitespace-nowrap font-medium text-gray-900 dark:text-white text-xs">02 Now 2025</td>
                            <td class="px-4 py-2">
                                <button id="-dropdown-button" type="button" data-dropdown-toggle="-dropdown" class="inline-flex items-center p-1 text-sm font-medium text-center text-gray-500 hover:text-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100">
                                    <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                        ...
                        <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <td class="px-4 py-2 whitespace-nowrap font-medium text-gray-900 dark:text-white text-xs">30 Oct 2025</td>
                            <td class="px-4 py-2">
                                <button id="-dropdown-button" type="button" data-dropdown-toggle="-dropdown" class="inline-flex items-center p-1 text-sm font-medium text-center text-gray-500 hover:text-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100">
                                    <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
