{{-- Flowbite Component: project-summary --}}
@props(['title' => 'Tailwind CSS Project Summary - Flowbite', 'description' => 'Get started with a premium admin dashboard interface built with Tailwind CSS and Flowbite featuring over 50 example pages of charts, calendars, kanban boards, dashboards, CRUD pages, mailing systems, and more.'])
    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
      ...
      <li aria-current="page">
        <div class="flex items-center">
          ...
          <span class="ms-1 text-sm font-medium text-gray-500 dark:text-gray-400 md:ms-2">Project summary</span>
        </div>
      </li>
    </ol>
  </nav>
  <h1 class="text-xl font-bold text-gray-900 dark:text-white">Project summary</h1>
</div>

<div class="mb-4 grid gap-4 px-4">
  <div class="rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800 md:p-6">
    <div>
      <h2 class="mb-2 text-xl font-bold text-gray-900 dark:text-white">Commits over time</h2>
      <p class="text-gray-500 dark:text-gray-400">Number of commits for this project</p>
    </div>

    <div id="commits-chart"></div>
  </div>
  <div class="rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800 md:p-6">
    <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white md:mb-6">Project information</h2>
    <div class="grid gap-4 sm:grid-cols-2 sm:gap-8 2xl:gap-60">
      <dl>
        <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Project name</dt>
        <dd class="mb-4 text-gray-500 dark:text-gray-400 sm:mb-5">Flowbite Website</dd>
        ...
        <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Team</dt>
        <dd class="mb-4 flex -space-x-4 sm:mb-5 rtl:space-x-reverse">
          <img class="h-10 w-10 rounded-full border-2 border-white dark:border-gray-800" src="/images/users/helene-engels.png" alt="User avatar" />
          <img class="h-10 w-10 rounded-full border-2 border-white dark:border-gray-800" src="/images/users/jese-leos.png" alt="User avatar" />
          <img class="h-10 w-10 rounded-full border-2 border-white dark:border-gray-800" src="/images/users/bonnie-green.png" alt="User avatar" />
          <a class="flex h-10 w-10 items-center justify-center rounded-full border-2 border-white bg-gray-700 text-xs font-medium text-white hover:bg-gray-600 dark:border-gray-800" href="#">+2</a>
        </dd>
        ...
        <dd class="flex items-center text-gray-900 dark:text-white">
          <svg class="me-1.5 h-4 w-4 text-gray-500 dark:text-gray-400 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
          ...
          <span class="font-medium">2 months</span>
        </dd>
      </dl>
      <dl>
        <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Project budget</dt>
        <dd class="mb-4 text-gray-500 dark:text-gray-400 sm:mb-5">$10,000 - $50,0000</dd>
        <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Beneficiary of the project</dt>
        <dd class="mb-4 text-gray-500 dark:text-gray-400 sm:mb-5">Flowbite LLC</dd>
        <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Project priority</dt>
        <dd class="mb-4 sm:mb-5">
          <span class="me-2 inline-flex items-center rounded-sm bg-red-100 px-2.5 py-0.5 text-sm font-medium text-red-800 dark:bg-red-900 dark:text-red-300">
        ...
        <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Tools</dt>
        <dd class="flex items-center space-x-2 text-gray-900 dark:text-white">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 18 17">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 12 17">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 13 19">
            <path
              fill="#000"
              fill-rule="evenodd"
          ...
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 16 15">
    ...
    <div class="mt-4 border-t border-gray-200 pt-4 dark:border-gray-700 sm:mt-5 sm:pt-5">
      <button
        type="button"
  ...
  <div class="relative overflow-hidden rounded-lg bg-white shadow-sm dark:bg-gray-800">
    <div class="flex-row items-start justify-between space-y-3 p-4 sm:flex sm:space-x-4 sm:space-y-0 sm:p-6">
      <div>
        <h2 class="me-3 text-xl font-bold dark:text-white">Files and assets</h2>
      ...
      <table class="w-full text-left text-sm text-gray-500 dark:text-gray-400">
        ...
        <tbody>
          <tr class="border-b border-gray-200 dark:border-gray-700">
            ...
            <td class="text-nowrap px-4 py-3 sm:px-6">
              <div class="mr-3 flex items-center font-medium text-gray-900 dark:text-white">
                <img src="/images/users/avatar-8.png" alt="User avatar" class="mr-3 h-8 w-auto rounded-full" />
                Roberta Casas
              </div>
            </td>
          ...
          <tr class="border-b border-gray-200 dark:border-gray-700">
            ...
            <td class="text-nowrap px-4 py-3 sm:px-6">
              <div class="mr-3 flex items-center font-medium text-gray-900 dark:text-white">
                <img src="/images/users/avatar-1.png" alt="User avatar" class="mr-3 h-8 w-auto rounded-full" />
                Bonnie Green
              </div>
            </td>
          ...
          <tr class="border-b border-gray-200 dark:border-gray-700">
            ...
            <td class="text-nowrap px-4 py-3 sm:px-6">
              <div class="mr-3 flex items-center font-medium text-gray-900 dark:text-white">
                <img src="/images/users/avatar-2.png" alt="User avatar" class="mr-3 h-8 w-auto rounded-full" />
                Leslie Livingston
              </div>
            </td>
            <td class="max-w-48 whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white sm:px-6">1 day ago</td>
          ...
          <tr class="border-b border-gray-200 dark:border-gray-700">
            ...
            <td class="text-nowrap px-4 py-3 sm:px-6">
              <div class="mr-3 flex items-center font-medium text-gray-900 dark:text-white">
                <img src="/images/users/avatar-3.png" alt="User avatar" class="mr-3 h-8 w-auto rounded-full" />
                Micheal Gough
              </div>
            </td>
          ...
          <tr class="border-b border-gray-200 dark:border-gray-700">
            ...
            <td class="text-nowrap px-4 py-3 sm:px-6">
              <div class="mr-3 flex items-center font-medium text-gray-900 dark:text-white">
                <img src="/images/users/avatar-4.png" alt="User avatar" class="mr-3 h-8 w-auto rounded-full" />
                Joseph McFall
              </div>
            </td>
            <td class="max-w-48 whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white sm:px-6">3 days ago</td>
          ...
          <tr class="border-b border-gray-200 dark:border-gray-700">
            ...
            <td class="text-nowrap px-4 py-3 sm:px-6">
              <div class="mr-3 flex items-center font-medium text-gray-900 dark:text-white">
                <img src="/images/users/avatar-5.png" alt="User avatar" class="mr-3 h-8 w-auto rounded-full" />
                Robert Brown
              </div>
            </td>
            <td class="max-w-48 whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white sm:px-6">3 days ago</td>
          ...
          <tr class="border-b border-gray-200 dark:border-gray-700">
            ...
            <td class="text-nowrap px-4 py-3 sm:px-6">
              <div class="mr-3 flex items-center font-medium text-gray-900 dark:text-white">
                <img src="/images/users/avatar-6.png" alt="User avatar" class="mr-3 h-8 w-auto rounded-full" />
                Karen Nelson
              </div>
            </td>
          ...
          <tr class="border-b border-gray-200 dark:border-gray-700">
            ...
            <td class="text-nowrap px-4 py-3 sm:px-6">
              <div class="mr-3 flex items-center font-medium text-gray-900 dark:text-white">
                <img src="/images/users/avatar-7.png" alt="User avatar" class="mr-3 h-8 w-auto rounded-full" />
                Helene Engels
              </div>
            </td>
          ...
          <tr class="border-b border-gray-200 dark:border-gray-700">
            ...
            <td class="px-4 py-3 sm:px-6">
              <div class="mr-3 flex items-center font-medium text-gray-900 dark:text-white">
                <img src="/images/users/avatar-9.png" alt="User avatar" class="mr-3 h-8 w-auto rounded-full" />
                Neils Sims
              </div>
            </td>
            <td class="max-w-48 whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white sm:px-6">1 week ago</td>
    ...
    <div class="relative rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800 sm:p-5">
      ...
      <div class="mt-4 flex items-center justify-between">
        ...
        <div class="flex items-center justify-between">
          <span class="text-sm font-medium text-gray-500 dark:text-gray-400 me-4">75%</span>
          <button type="button" data-tooltip-target="tooltip-cancel-1" class="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
      ...
      <div class="mt-4 flex items-center justify-between">
        ...
        <div class="flex items-center justify-between">
          <span class="text-sm font-medium text-gray-500 dark:text-gray-400 me-4">36%</span>
          <button type="button" data-tooltip-target="tooltip-cancel-2" class="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
            <svg class="h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
              <path
                fill-rule="evenodd"
                d="M2 12a10 10 0 1 1 20 0 10 10 0 0 1-20 0Zm7.7-3.7a1 1 0 0 0-1.4 1.4l2.3 2.3-2.3 2.3a1 1 0 1 0 1.4 1.4l2.3-2.3 2.3 2.3a1 1 0 0 0 1.4-1.4L13.4 12l2.3-2.3a1 1 0 0 0-1.4-1.4L12 10.6 9.7 8.3Z"
