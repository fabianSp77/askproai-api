{{-- Flowbite Component: to-do-upcoming --}}
@props(['title' => 'Tailwind CSS Upcoming To-Do Page - Flowbite', 'description' => 'Get started with a premium admin dashboard interface built with Tailwind CSS and Flowbite featuring over 50 example pages of charts, calendars, kanban boards, dashboards, CRUD pages, mailing systems, and more.'])
...
>
  <div>
    ...
    <h1
      class="mb-4 text-xl font-semibold text-gray-900 dark:text-white sm:mb-0"
    >
      Upcoming tasks
    </h1>
  </div>
...
<div class="space-y-4 px-4 xl:me-96">
  <!-- High Tasks Block -->
  <div>
