{{-- Flowbite Component: footer-main --}}
@props(['title' => '', 'description' => ''])
<div {{ $attributes->merge(['class' => '']) }}>
<footer class="bg-white dark:bg-gray-900">
  <div class="mx-auto max-w-screen-xl p-4 py-6 sm:py-16 md:p-8 lg:p-10 lg:py-24">
    ...
    <div class="text-center">
      <a href="#" class="mb-5 flex items-center justify-center text-2xl font-semibold text-gray-900 dark:text-white">
      ...
      <span class="block text-center text-sm text-gray-500 dark:text-gray-400">© 2021-2025 <a href="#" class="hover:underline">Flowbite™</a>. All Rights Reserved. </span>
