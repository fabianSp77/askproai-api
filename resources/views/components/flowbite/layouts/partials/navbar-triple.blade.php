{{-- Flowbite Component: navbar-triple --}}
@props(['title' => '', 'description' => ''])
<div {{ $attributes->merge(['class' => '']) }}>
<header class="bg-white antialiased dark:bg-gray-800">
  <nav class=" flex w-full items-center border-b border-gray-200 px-4 py-2.5 dark:border-gray-700">
    <div class="flex w-full items-center justify-between">
      <div class="flex items-center justify-start">
        <button
          ...
          class="me-2 inline cursor-pointer rounded-sm p-1.5 text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white sm:-ms-1"
        >
      ...
      <div class="flex items-center lg:order-2">
        <div class="flex items-center space-x-1 sm:border-e sm:border-gray-200 sm:pe-4 sm:dark:border-gray-700">
          <button id="toggleSidebarMobileSearch" type="button" class="rounded-lg p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white lg:hidden">
          ...
          <div class="z-50 my-4 block hidden max-w-sm divide-y divide-gray-200 overflow-hidden rounded-lg bg-white shadow-md dark:divide-gray-600 dark:bg-gray-700" id="notification-dropdown" data-popper-placement="bottom">
            ...
            <div class="relative max-h-96 overflow-y-scroll">
              <a href="#" class="flex border-b px-4 py-3 hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-600">
                <div class="shrink-0">
                  <img class="h-11 w-11 rounded-full" src="/images/users/lana-byrd.png" alt="Lana avatar" />
              ...
              <a href="#" class="flex border-b px-4 py-3 hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-600">
                <div class="shrink-0">
                  <img class="h-11 w-11 rounded-full" src="/images/users/jese-leos.png" alt="Jese Leos avatar" />
              ...
              <a href="#" class="flex border-b px-4 py-3 hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-600">
                <div class="shrink-0">
                  <img class="h-11 w-11 rounded-full" src="/images/users/bonnie-green.png" alt="Bonnie avatar" />
              ...
              <a href="#" class="flex border-b px-4 py-3 hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-600">
                <div class="shrink-0">
                  <img class="h-11 w-11 rounded-full" src="/images/users/joseph-mcfall.png" alt="Joseph McFall avatar" />
              ...
              <a href="#" class="flex border-b px-4 py-3 hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-600">
                <div class="shrink-0">
                  <img class="h-11 w-11 rounded-full" src="/images/users/roberta-casas.png" alt="Roberta Casas image" />
            ...
            <a href="#" class="block bg-gray-100 py-2 text-center text-base font-medium text-gray-900 hover:bg-gray-200 dark:bg-gray-700 dark:text-white dark:hover:underline">
          ...
          <div class="z-50 my-4 hidden max-w-sm list-none overflow-hidden rounded-lg bg-white text-base shadow-md dark:bg-gray-700" id="apps-dropdown">
            ...
            <div class="grid grid-cols-3 gap-4 p-4">
              <a href="{{ "/calendar/" | relURL }}" class="group block rounded-md bg-gray-50 p-4 text-center hover:bg-gray-100 dark:bg-gray-600 dark:hover:bg-gray-500">
                <svg
              ...
              <a href="{{ "video/meeting-room/" | relURL }}" class="group block rounded-md bg-gray-50 p-4 text-center hover:bg-gray-100 dark:bg-gray-600 dark:hover:bg-gray-500">
                <svg
                  class="mx-auto mb-2 h-5 w-5 text-gray-400 group-hover:text-gray-500 dark:text-gray-400 dark:group-hover:text-gray-400"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <a href="{{ "pages/text-editor/" | relURL }}" class="group block rounded-md bg-gray-50 p-4 text-center hover:bg-gray-100 dark:bg-gray-600 dark:hover:bg-gray-500">
                <svg
                  class="mx-auto mb-2 h-5 w-5 text-gray-400 group-hover:text-gray-500 dark:text-gray-400 dark:group-hover:text-gray-400"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <a href="{{ "/chat/" | relURL }}" class="group block rounded-md bg-gray-50 p-4 text-center hover:bg-gray-100 dark:bg-gray-600 dark:hover:bg-gray-500">
                <svg
                  class="mx-auto mb-2 h-5 w-5 text-gray-400 group-hover:text-gray-500 dark:text-gray-400 dark:group-hover:text-gray-400"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <a href="{{ "pages/datatables/" | relURL }}" class="group block rounded-md bg-gray-50 p-4 text-center hover:bg-gray-100 dark:bg-gray-600 dark:hover:bg-gray-500">
                <svg
                  class="mx-auto mb-2 h-5 w-5 text-gray-400 group-hover:text-gray-500 dark:text-gray-400 dark:group-hover:text-gray-400"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <a href="{{ "/kanban/" | relURL }}" class="group block rounded-md bg-gray-50 p-4 text-center hover:bg-gray-100 dark:bg-gray-600 dark:hover:bg-gray-500">
                <svg
                  class="mx-auto mb-2 h-5 w-5 text-gray-400 group-hover:text-gray-500 dark:text-gray-400 dark:group-hover:text-gray-400"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <a href="{{ "mailing/inbox/" | relURL }}" class="group block rounded-md bg-gray-50 p-4 text-center hover:bg-gray-100 dark:bg-gray-600 dark:hover:bg-gray-500">
                <svg
                  class="mx-auto mb-2 h-5 w-5 text-gray-400 group-hover:text-gray-500 dark:text-gray-400 dark:group-hover:text-gray-400"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <a href="{{ "support/tickets/" | relURL }}" class="group block rounded-md bg-gray-50 p-4 text-center hover:bg-gray-100 dark:bg-gray-600 dark:hover:bg-gray-500">
                <svg
                  class="mx-auto mb-2 h-5 w-5 text-gray-400 group-hover:text-gray-500 dark:text-gray-400 dark:group-hover:text-gray-400"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <a href="{{ "pages/api/" | relURL }}" class="group block rounded-md bg-gray-50 p-4 text-center hover:bg-gray-100 dark:bg-gray-600 dark:hover:bg-gray-500">
                <svg
                  class="mx-auto mb-2 h-5 w-5 text-gray-400 group-hover:text-gray-500 dark:text-gray-400 dark:group-hover:text-gray-400"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
        ...
        >
          ...
          <img class="h-8 w-8 shrink-0 rounded-full" src="/images/users/jese-leos.png" alt="user photo" />
        </button>
        <!-- Dropdown menu -->
  ...
  <nav class="px-4 py-2.5 dark:bg-gray-800">
    <div class="flex flex-wrap items-center justify-between">
      <div class="mb-2 flex items-center sm:mb-0">
        <button
          ...
          class="dark:hover-bg-gray-700 flex items-center justify-between rounded-lg p-2 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700"
          type="button"
        >
          <span class="sr-only">Open user menu</span>
          <div class="mr-2 flex items-center">
            <img src="/images/users/bonnie-green.png" class="mr-2 h-7 w-7 rounded-full" alt="Bonnie avatar" />
            <div class="text-left">
              <div class="text-sm font-semibold leading-none text-gray-900 dark:text-white">Personal</div>
            </div>
          </div>
          <svg class="h-3 w-3 text-gray-900 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 16">
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5 5 1 1 5m0 6 4 4 4-4" />
          </svg>
        </button>
        <!-- Dropdown menu -->
        <div id="dropdownUserName" class="z-30 hidden w-48 divide-y divide-gray-100 rounded-lg bg-white shadow-sm dark:divide-gray-600 dark:bg-gray-700" data-popper-placement="bottom">
          <a href="#" class="flex items-center rounded-lg px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-600">
            <div class="text-left">
              <div class="mb-0.5 text-sm font-medium leading-none text-gray-900 dark:text-white">Company</div>
              <div class="text-xs text-gray-500 dark:text-gray-400">Created August, 2014</div>
            </div>
          </a>
          <a href="#" class="flex items-center rounded-sm px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-600">
            <div class="text-left">
              <div class="mb-0.5 text-sm font-medium leading-none text-gray-900 dark:text-white">Personal</div>
              <div class="text-xs text-gray-500 dark:text-gray-400">Created September, 2018</div>
            </div>
          </a>
        </div>
        <svg class="mx-2 h-3 w-3 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
        ...
        <button
          ...
          class="focus:ring-gray-2ç00 items-center rounded-lg p-2 pl-4 pr-3 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-900 focus:ring-4 focus:ring-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-600 md:inline-flex"
        >
          flowbite.com
        </button>
        <div id="regionDropdown" class="z-30 hidden w-60 divide-y divide-gray-100 rounded-md bg-white shadow-sm dark:divide-gray-600 dark:bg-gray-700">
          <ul class="space-y-1 p-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="regionDropdownButton">
            <li>
              <div class="flex rounded-md p-2 hover:bg-gray-100 dark:hover:bg-gray-600">
      ...
      <div class="grid w-full grid-cols-2 gap-2 sm:flex sm:w-auto sm:items-center">
        <button
          type="button"
          class="rounded-lg bg-primary-700 px-3 py-2 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 sm:mr-2"
        >
          Open app
        </button>
        <button
        ...
        <div class="z-50 my-4 hidden w-48 list-none divide-y divide-gray-100 rounded-sm bg-white text-base shadow-sm dark:divide-gray-600 dark:bg-gray-700" id="moreOptionsDropdown">
          <ul class="p-2 text-sm font-medium text-gray-500 dark:text-gray-400" aria-labelledby="moreOptionsDropdownButton">
            <li>
  ...
  <nav id="toggleMobileMenu" class="hidden border-b border-t border-gray-200 px-4 pt-2.5 shadow-xs dark:border-gray-700 lg:block">
    <div>
      <div class="flex items-center">
        <ul class="mt-0 flex w-full flex-col text-sm font-medium lg:flex-row">
          <li class="block border-b dark:border-gray-700 border-gray-200 lg:inline lg:border-b-0">
            <a href="/" class="block border-b-2 border-primary-600 px-4 py-3 text-primary-600 hover:text-primary-600 dark:border-primary-500 dark:text-primary-500" aria-current="page">Home</a>
          </li>
          <li class="block border-b dark:border-gray-700 border-gray-200 lg:inline lg:border-b-0">
            <a href="#" class="block px-4 py-3 text-gray-500 hover:border-b-2 hover:border-primary-600 hover:text-primary-600 dark:text-gray-400 dark:hover:border-primary-500 dark:hover:text-primary-500">Company</a>
          </li>
          <li class="block border-b dark:border-gray-700 border-gray-200 lg:inline lg:border-b-0">
            <a href="#" class="block px-4 py-3 text-gray-500 hover:border-b-2 hover:border-primary-600 hover:text-primary-600 dark:text-gray-400 dark:hover:border-primary-500 dark:hover:text-primary-500">Team</a>
          </li>
          <li class="block border-b dark:border-gray-700 border-gray-200 lg:inline lg:border-b-0">
            <a href="#" class="block px-4 py-3 text-gray-500 hover:border-b-2 hover:border-primary-600 hover:text-primary-600 dark:text-gray-400 dark:hover:border-primary-500 dark:hover:text-primary-500">Features</a>
          </li>
          <li class="block border-b dark:border-gray-700 border-gray-200 lg:inline lg:border-b-0">
            <a href="#" class="block px-4 py-3 text-gray-500 hover:border-b-2 hover:border-primary-600 hover:text-primary-600 dark:text-gray-400 dark:hover:border-primary-500 dark:hover:text-primary-500">Marketplace</a>
          </li>
          <li class="block border-b dark:border-gray-700 border-gray-200 lg:inline lg:border-b-0">
            <a href="#" class="block px-4 py-3 text-gray-500 hover:border-b-2 hover:border-primary-600 hover:text-primary-600 dark:text-gray-400 dark:hover:border-primary-500 dark:hover:text-primary-500">Resources</a>
          </li>
          <li class="block border-b dark:border-gray-700 border-gray-200 lg:inline lg:border-b-0">
            <a href="#" class="block px-4 py-3 text-gray-500 hover:border-b-2 hover:border-primary-600 hover:text-primary-600 dark:text-gray-400 dark:hover:border-primary-500 dark:hover:text-primary-500">Forum</a>
          </li>
          <li class="block lg:inline">
            <a href="#" class="block px-4 py-3 text-gray-500 hover:border-b-2 hover:border-primary-600 hover:text-primary-600 dark:text-gray-400 dark:hover:border-primary-500 dark:hover:text-primary-500">Support</a>
          </li>
        </ul>
      </div>
    </div>
