...
<body>
    ...
    <div class="section">
        ...
        <div class="info-grid">
            ...
            @if($call->urgency_level || (isset($call->metadata['customer_data']['urgency']) ? $call->metadata['customer_data']['urgency'] : null))
            <div class="info-row">
                <div class="info-label">Dringlichkeit:</div>
                <div class="info-value">
                    @php
                        $urgency = $call->urgency_level ?? (isset($call->metadata['customer_data']['urgency']) ? $call->metadata['customer_data']['urgency'] : null);
            ...
            <div class="info-row">
                ...
                <div class="info-value">{{ $call->callPortalData?->assignedTo?->name ?? 'Nicht zugewiesen' }}</div>
            </div>
        </div>
    </div>
    ...
    {{-- Customer Request --}}
    @if($call->reason_for_visit || $call->metadata['customer_data']['request'] ?? null)
    <div class="section">
