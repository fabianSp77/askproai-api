<div wire:init="loadBranches">
    ...
    <div x-data="{ open: false }" class="relative hidden sm:block">
        ...
        >
            ...
            <span>
                @if($isLoading)
                    <span class="text-gray-400">Lade...</span>
            ...
            <div class="py-1">
                ...
                @forelse($branches as $branch)
                    <button
                        ...
                        @if(!$branch['is_active']) disabled @endif
                    >
                        <div class="flex-1">
    ...
    {{-- Loading State --}}
    <div wire:loading.delay wire:target="switchBranch" class="absolute inset-0 flex items-center justify-center bg-white/50 dark:bg-gray-900/50 rounded-lg">
