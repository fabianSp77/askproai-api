<div>
    ...
    <div class="relative hidden sm:block">
        <div x-data="{ 
            open: false,
            selected: @entangle('currentBranchId').defer
        }">
    ...
    {{-- Loading Overlay --}}
    <div wire:loading wire:target="switchBranch" class="fixed inset-0 bg-black bg-opacity-25 z-50 flex items-center justify-center">
