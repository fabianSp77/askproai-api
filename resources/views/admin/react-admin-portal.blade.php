...
<head>
    ...
    <script src="/js/components/admin/CustomerDetailView.jsx" type="text/babel"></script>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <script type="text/babel">
        ...
        const useParams = () => {
            ...
            // Simple ID extraction for detail pages
            if (parts.length === 2) {
        ...
        const RouterProvider = ({ children }) => {
            const [currentPath, setCurrentPath] = useState(window.location.pathname.replace('/admin-react', '') || '/');
            const [params, setParams] = useState({});
            
            const navigate = useCallback((path) => {
                const fullPath = `/admin-react${path}`;
            ...
            useEffect(() => {
                const handlePopState = () => {
                    const path = window.location.pathname.replace('/admin-react', '') || '/';
                    setCurrentPath(path);
                };
            ...
            const value = { currentPath, params, setParams, navigate };
        ...
        const Route = ({ path, element }) => {
            ...
            const result = matchPath(path === '/' ? '/' : path, currentPath);
        ...
        const Link = ({ to, children, className, ...props }) => {
            ...
            return (
                <a href={`/admin-react${to}`} onClick={handleClick} className={className} {...props}>
                    {children}
                </a>
            );
        };
        ...
        const NavLink = ({ to, children, className, ...props }) => {
            ...
            return <Link to={to} className={finalClassName} {...props}>{children}</Link>;
        };

        // Lucide React Icons Component
        const Icon = (props) => {
            const { name, size = 20, color = 'currentColor', className = '' } = props;
            useEffect(() => {
                lucide.createIcons();
            }, []);
        ...
        const TranslationProvider = ({ children }) => {
            const [locale, setLocale] = useState(localStorage.getItem('admin_locale') || 'de');
            ...
            const loadTranslations = async (lang) => {
                try {
                    setLoading(true);
                    const data = await apiCall(`/translations/${lang}`);
                    setTranslations(data.translations || {});
                    localStorage.setItem('admin_locale', lang);
                } catch (error) {
                    console.error('Failed to load translations:', error);
                    // Fallback to empty translations to prevent errors
                    setTranslations({});
                } finally {
                    setLoading(false);
                }
            ...
            return (
                <TranslationContext.Provider value={{ locale, translations, t, changeLocale, loading }}>
                    {children}
        ...
        const LanguageSelector = () => {
            ...
            const loadLanguages = async () => {
                try {
                    const data = await apiCall('/translations/languages');
            ...
            return (
                <div style={{ position: 'relative' }}>
                    ...
                    >
                        ...
                        <span>{currentLanguage ? currentLanguage[1] : locale.toUpperCase()}</span>
                            ...
                            {languages.map(([code, name]) => (
                                <button
                                    ...
                                    style={{
                                        ...
                                        width: '100%',
                                        padding: '8px 16px',
                                        background: locale === code ? '#f3f4f6' : 'transparent',
                                        border: 'none',
                                        cursor: 'pointer',
                                        textAlign: 'left',
                                        fontSize: 14,
                                    ...
                                    onMouseLeave={(e) => e.target.style.background = locale === code ? '#f3f4f6' : 'transparent'}
                                >
                                    {name}
                                </button>
                            ))}
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="modal-body">
                                <div className="form-section">
                                    <h3 className="form-section-title">{t('customer.personal_info')}</h3>
                                ...
                                <div className="form-section">
                                    <h3 className="form-section-title">{t('customer.address')}</h3>
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="form-group col-span-2">
                                            <label className="form-label">{t('customer.street')}</label>
                                            <input
                                                type="text"
                                                className="form-input"
                                        ...
                                        <div className="form-group">
                                            <label className="form-label">{t('customer.postal_code')}</label>
                                            <input
                                                type="text"
                                                className="form-input"
                                        ...
                                        <div className="form-group">
                                            <label className="form-label">{t('customer.city')}</label>
                                            <input
                                                type="text"
                                                className="form-input"
                                                value={formData.city}
                                ...
                                <div className="form-section">
                                    <h3 className="form-section-title">{t('customer.assignment')}</h3>
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="form-group">
                                            <label className="form-label">{t('customer.company')}</label>
                                            <select
                                                className="form-input"
                                                value={formData.company_id}
                                                onChange={(e) => setFormData({...formData, company_id: e.target.value, branch_id: ''})}
                                            >
                                                <option value="">{t('customer.please_select')}</option>
                                        ...
                                        <div className="form-group">
                                            <label className="form-label">{t('customer.branch')}</label>
                                            <select
                                                className="form-input"
                                ...
                                <div className="form-section">
                                    <h3 className="form-section-title">{t('customer.categorization')}</h3>
                                    <div className="form-group">
                                        <label className="form-label">{t('customer.tags')}</label>
                                        <TagInput
                                            value={formData.tags}
                                    ...
                                    <div className="form-group">
                                        <label className="checkbox-label">
                                            ...
                                            />
                                            <span>{t('customer.vip')}</span>
                                        </label>
                                    </div>
                                </div>

                                <div className="form-section">
                                    <h3 className="form-section-title">{t('customer.communication')}</h3>
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="form-group">
                                            <label className="form-label">{t('customer.preferred_contact')}</label>
                                            <select
                                                className="form-input"
                                        ...
                                        <div className="form-group">
                                            <label className="form-label">{t('customer.language')}</label>
                                            <select
                                                className="form-input"
                                    ...
                                    <div className="form-group">
                                        <label className="checkbox-label">
                                            ...
                                            />
                                            <span>{t('customer.marketing_consent')}</span>
                                        </label>
                                    </div>
                                </div>

                                <div className="form-section">
                                    <h3 className="form-section-title">{t('customer.portal_access')}</h3>
                                    <div className="form-group">
                                        <label className="checkbox-label">
                                            <input
                                                type="checkbox"
                                            ...
                                            />
                                            <span>{t('customer.portal_enabled')}</span>
                                        </label>
                                    </div>
                            ...
                            <div className="modal-footer">
                                ...
                                <button type="submit" className="btn btn-primary" disabled={loading}>
                                    {loading ? t('common.loading') : (customer ? t('common.save') : t('common.save'))}
                                </button>
                            </div>
                        </form>
                    </div>
        ...
        const AppLayout = ({ children }) => {
            ...
            const navigationItems = [
                { id: 'dashboard', path: '/', label: t('nav.dashboard'), icon: 'layout-dashboard' },
                { id: 'calls', path: '/calls', label: t('nav.calls'), icon: 'phone' },
                { id: 'appointments', path: '/appointments', label: t('nav.appointments'), icon: 'calendar' },
                { id: 'customers', path: '/customers', label: t('nav.customers'), icon: 'users' },
                { id: 'companies', path: '/companies', label: 'Unternehmen', icon: 'building' },
                { id: 'branches', path: '/branches', label: 'Filialen', icon: 'map-pin' },
                { id: 'staff', path: '/staff', label: 'Mitarbeiter', icon: 'user-check' },
                { id: 'services', path: '/services', label: 'Dienstleistungen', icon: 'briefcase' },
                { id: 'analytics', path: '/analytics', label: t('nav.analytics'), icon: 'bar-chart-3' },
                ...
                <>
                    ...
                    <div className="stats-grid">
                        <div className="stat-card">
                            ...
                            <div className="stat-value">{stats?.calls?.this_month || 0}</div>
                            <div className="stat-label">{t('stats.total_calls')}</div>
                        ...
                        <div className="stat-card">
                            ...
                            <div className="stat-value">{stats?.appointments?.this_month || 0}</div>
                        ...
                        <div className="stat-card">
                            ...
                            <div className="stat-value">{stats?.overview?.total_companies || 0}</div>
        ...
        const CallsView = () => {
            ...
            useEffect(() => {
                ...
                if (showLiveCalls) {
                    ...
                    interval = setInterval(loadLiveCalls, 5000);
                }
                return () => {
                ...
                <>
                    <div className="page-header">
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            ...
                            <button 
                                className="btn btn-primary"
                                onClick={() => setShowLiveCalls(!showLiveCalls)}
                                style={{ 
                                    display: 'flex', 
                                    alignItems: 'center', 
                                    gap: 8,
                                    background: showLiveCalls ? '#ef4444' : '#3b82f6'
                                }}
                            >
                                <div style={{ 
                                    width: 12, 
                                    height: 12, 
                                    borderRadius: '50%', 
                                    background: showLiveCalls ? '#fff' : '#10b981',
                                    animation: showLiveCalls ? 'pulse 1.5s infinite' : 'none'
                                }} />
                                {showLiveCalls ? t('calls.hide_live') : t('calls.show_live')}
                            </button>
                        </div>
                    </div>
                        ...
                        <div style={{ 
                            ...
                            <h3 style={{ margin: '0 0 16px 0', color: '#dc2626' }}>
                                <span style={{ display: 'inline-flex', alignItems: 'center', gap: 8 }}>
                                    ...
                                    {t('calls.active_calls')} ({liveCalls.length})
                                </span>
                            </h3>
                            {liveCalls.length === 0 ? (
                                ...
                                <div style={{ display: 'grid', gap: 12, gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))' }}>
                                    {liveCalls.map(call => (
                                        <div key={call.id} style={{
                                            ...
                                            <div style={{ flex: 1 }}>
                                                <div style={{ fontWeight: 500 }}>{call.from_phone_number}</div>
                                                <div style={{ fontSize: 14, color: '#6b7280' }}>
                                                    {Math.floor((Date.now() - new Date(call.created_at).getTime()) / 1000)}s
                                                </div>
                                            </div>
                                            <button
                                            ...
                                            <tr key={call.id} className={`call-row ${getSentimentColor(call.sentiment)}`}>
                                                ...
                                                <td>
                                                    {call.is_non_billable ? (
                                                        ...
                                                        <span>€{(parseFloat(call.cost) || 0).toFixed(2)}</span>
                                                    )}
                                                </td>
                                                <td>
        ...
        const CallDetailModal = ({ call, onClose }) => {
            ...
            // Calculate customer revenue based on company billing rates
            const calculateCustomerRevenue = () => {
                if (!callDetails || !callDetails.duration_sec) return 0;
                // Assuming company has billing rates per minute
                const billingRatePerMin = callDetails.company?.billing_rate_per_min || 1.50; // Default €1.50 per minute
                const durationMin = Math.ceil(callDetails.duration_sec / 60);
                return (durationMin * billingRatePerMin).toFixed(2);
            };

            const calculateProfit = () => {
                const revenue = parseFloat(calculateCustomerRevenue());
                const cost = parseFloat(callDetails?.cost || 0);
                return (revenue - cost).toFixed(2);
            };

            const getProfitColor = (profit) => {
                const profitValue = parseFloat(profit);
                if (profitValue > 0) return '#10b981';
                if (profitValue < 0) return '#ef4444';
                return '#6b7280';
            };
                        ...
                        {loading ? (
                            ...
                            <>
                                    ...
                                    <div style={{ display: 'flex', gap: 24 }}>
                                        ...
                                        <button
                                            ...
                                            style={{
                                                ...
                                                borderBottom: activeTab === 'costs' ? '2px solid #3b82f6' : '2px solid transparent',
                                                cursor: 'pointer'
                                            }}
                                        >
                                            {t('call_detail.costs_revenue')}
                                        </button>
                                        <button
                                ...
                                <div style={{ padding: 20 }}>
                                    ...
                                    {activeTab === 'costs' && (
                                        <div className="card">
                                            <h4 style={{ marginBottom: 24 }}>Kosten & Einnahmen Übersicht</h4>
                                            ...
                                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 20, marginBottom: 32 }}>
                                                ...
                                                <div style={{ 
                                                    ...
                                                    <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
                                                        <Icon name="trending-down" size={20} style={{ color: '#ef4444' }} />
                                                        <h5 style={{ margin: 0, color: '#991b1b' }}>Unsere Kosten</h5>
                                                    </div>
                                                    <div style={{ fontSize: 32, fontWeight: 700, color: '#dc2626' }}>
                                                        €{(parseFloat(callDetails.cost) || 0).toFixed(2)}
                                                    </div>
                                                ...
                                                <div style={{ 
                                                    ...
                                                    <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
                                                        <Icon name="trending-up" size={20} style={{ color: '#10b981' }} />
                                                        <h5 style={{ margin: 0, color: '#065f46' }}>Kundenrechnung</h5>
                                                    </div>
                                                    <div style={{ fontSize: 32, fontWeight: 700, color: '#059669' }}>
                                                        €{calculateCustomerRevenue()}
                                                    </div>
                                                    <div style={{ fontSize: 14, color: '#064e3b', marginTop: 4 }}>
                                                        Berechnet an Kunde
                                                    </div>
                                                </div>
                                                ...
                                                <div style={{ 
                                                    ...
                                                    <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
                                                        <Icon name="calculator" size={20} style={{ color: '#6b7280' }} />
                                                        <h5 style={{ margin: 0, color: '#374151' }}>Gewinn</h5>
                                                    </div>
                                                    <div style={{ 
                                                        fontSize: 32, 
                                                        fontWeight: 700, 
                                                        color: getProfitColor(calculateProfit())
                                                    }}>
                                                        €{calculateProfit()}
                                                    </div>
                                                    <div style={{ fontSize: 14, color: '#4b5563', marginTop: 4 }}>
                                                        Marge: {parseFloat(calculateCustomerRevenue()) > 0 ? ((parseFloat(calculateProfit()) / parseFloat(calculateCustomerRevenue())) * 100).toFixed(1) : '0.0'}%
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div style={{ background: '#f9fafb', padding: 20, borderRadius: 8 }}>
                                                <h5 style={{ marginBottom: 16 }}>Detaillierte Aufschlüsselung</h5>
                                                
                                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
                                                    {/* Cost Details */}
                                                    <div>
                                                        <h6 style={{ marginBottom: 12, color: '#6b7280' }}>Kostenaufstellung (Retell.ai)</h6>
                                                        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                                                            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                                                <span>Anrufdauer</span>
                                                                <span>{callDetails.duration_formatted}</span>
                                                            </div>
                                                            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                                                <span>Minuten (gerundet)</span>
                                                                <span>{Math.ceil(callDetails.duration_sec / 60)} Min.</span>
                                                            </div>
                                                            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                                                <span>Kosten pro Minute</span>
                                                                <span>€0.10</span>
                                                            </div>
                                                            <hr style={{ margin: '8px 0', border: 'none', borderTop: '1px solid #e5e7eb' }} />
                                                            <div style={{ display: 'flex', justifyContent: 'space-between', fontWeight: 600 }}>
                                                                <span>Gesamtkosten</span>
                                                                <span style={{ color: '#dc2626' }}>€{(parseFloat(callDetails.cost) || 0).toFixed(2)}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    {/* Revenue Details */}
                                                    <div>
                                                        <h6 style={{ marginBottom: 12, color: '#6b7280' }}>Kundenabrechnung</h6>
                                                        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                                                            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                                                <span>Anrufdauer</span>
                                                                <span>{callDetails.duration_formatted}</span>
                                                            ...
                                                            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                                                <span>Tarif pro Minute</span>
                                                                <span>€{callDetails.company?.billing_rate_per_min || 1.50}</span>
                                                            </div>
                                                            <hr style={{ margin: '8px 0', border: 'none', borderTop: '1px solid #e5e7eb' }} />
                                                            <div style={{ display: 'flex', justifyContent: 'space-between', fontWeight: 600 }}>
                                                                <span>Gesamtrechnung</span>
                                                                <span style={{ color: '#059669' }}>€{calculateCustomerRevenue()}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            {/* Additional Info */}
                                            <div style={{ marginTop: 20, padding: 16, background: '#eff6ff', borderRadius: 8 }}>
                                                <div style={{ display: 'flex', alignItems: 'start', gap: 12 }}>
                                                    <Icon name="info" size={20} style={{ color: '#3b82f6', marginTop: 2 }} />
                                                    <div style={{ fontSize: 14, color: '#1e40af' }}>
                                                        <strong>Hinweis:</strong> Die Kundenabrechnung basiert auf dem hinterlegten Tarif des Unternehmens. 
                                                        Der aktuelle Tarif beträgt €{callDetails.company?.billing_rate_per_min || 1.50} pro Minute. 
                                                        Dieser kann in den Unternehmenseinstellungen angepasst werden.
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    {activeTab === 'transcript' && (
                                        <div className="transcript-viewer" style={{ margin: 0 }}>
                                            <div className="transcript-header">
                                                <h4>Gesprächstranskript</h4>
                                                <button 
                                                    className="btn btn-sm btn-secondary"
                                                    onClick={() => setShowTranscript(!showTranscript)}
                                                >
                                                    <Icon name={showTranscript ? 'chevron-up' : 'chevron-down'} size={16} />
                                                    {showTranscript ? 'Verbergen' : 'Vollständig anzeigen'}
                                                </button>
                                            </div>
                                            {callDetails.transcript ? (
                                                <div className="transcript-content" style={{ maxHeight: showTranscript ? 'none' : '200px', overflow: 'hidden' }}>
        ...
        const AppointmentsView = () => {
            ...
            const loadQuickFilterCounts = async () => {
                try {
                    ...
                    const data = await apiCall(`/appointments/quick-filters${params}`);
            ...
            const loadBranches = async (companyId) => {
                ...
                try {
                    const data = await apiCall(`/branches?company_id=${companyId}`);
            ...
            const handleSendReminder = async (appointmentId) => {
                try {
                    await apiCall(`/appointments/${appointmentId}/send-reminder`, {
                        method: 'POST'
                    });
            ...
            const handleBulkAction = async () => {
                ...
                try {
                    const data = await apiCall('/appointments/bulk-action', {
                        method: 'POST',
                        body: JSON.stringify({
                ...
                <div>
                    <div className="page-header">
                        <div className="flex justify-between items-center">
                            <div>
                                <h1 className="page-title">{t('nav.appointments')}</h1>
                                    ...
                                    <tbody>
                                        {appointments.map((appointment, index) => (
                                            <tr key={appointment.id} className={`border-b border-gray-200 hover:bg-gray-50 ${getRowHighlight(appointment)}`}>
                                                ...
                                                <td className="px-4 py-3 text-sm">
                                                    {appointment.price ? `€${parseFloat(appointment.price).toFixed(2)}` : '-'}
                                                </td>
                                                <td className="px-4 py-3">
                            ...
                            <div>
                                <div className="stats-grid" style={{ marginBottom: 32 }}>
                                    ...
                                    <div className="stat-card">
                                        ...
                                        <div className="stat-value">€{(parseFloat(stats?.total_revenue) || 0).toFixed(2)}</div>
        ...
        const AppointmentModal = ({ appointment, onClose, onSave }) => {
            ...
            const loadFormData = async () => {
                try {
                    const [companiesData, customersData, servicesData, staffData] = await Promise.all([
                        apiCall('/companies'),
                        apiCall('/customers'),
                        apiCall('/services'),
                        apiCall('/staff')
                    ...
                    if (formData.company_id) {
                        const branchesData = await apiCall(`/branches?company_id=${formData.company_id}`);
        ...
        const AppointmentDetailPage = () => {
            ...
            const loadAppointment = async () => {
                try {
                    ...
                    showToast('Fehler beim Laden des Termins', 'error');
                } finally {
                    setLoading(false);
                }
            };
            ...
            const getStatusBadge = (status) => {
                const statusConfig = {
                    'scheduled': { bg: 'bg-blue-100', text: 'text-blue-800', label: 'Geplant' },
                    'confirmed': { bg: 'bg-green-100', text: 'text-green-800', label: 'Bestätigt' },
                    'completed': { bg: 'bg-gray-100', text: 'text-gray-800', label: 'Abgeschlossen' },
                ...
                return (
                    <span className={`inline-flex items-center px-2 py-1 rounded-full text-sm font-medium ${config.bg} ${config.text}`}>
                        {config.label}
                    </span>
                );
            };
            ...
            if (!appointment) {
                return (
                    <div className="text-center py-12">
                        <h3 className="text-lg font-medium text-gray-900">Termin #{id} nicht gefunden</h3>
                        <p className="text-gray-600 mt-2">Der angeforderte Termin existiert nicht oder Sie haben keine Berechtigung.</p>
                ...
                <div>
                    ...
                    <nav className="mb-6">
                        <ol className="flex items-center space-x-2">
                            ...
                            <li className="text-gray-900">Termin #{appointment.id}</li>
                        </ol>
                    </nav>
                        ...
                        <div className="p-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-6">
                                    <div>
                                        <h3 className="text-lg font-medium text-gray-900 mb-4">Termindetails</h3>
                                        <dl className="space-y-3">
                                            <div>
                                                <dt className="text-sm font-medium text-gray-500">Datum & Zeit</dt>
                                                <dd className="text-sm text-gray-900">{formatDate(appointment.starts_at)}</dd>
                                            </div>
                                            <div>
                                                <dt className="text-sm font-medium text-gray-500">Dauer</dt>
                                                <dd className="text-sm text-gray-900">{appointment.duration} Minuten</dd>
                                            </div>
                                            <div>
                                                <dt className="text-sm font-medium text-gray-500">Dienstleistung</dt>
                                                <dd className="text-sm text-gray-900">{appointment.service?.name || '-'}</dd>
                                            </div>
                                            <div>
                                                <dt className="text-sm font-medium text-gray-500">Mitarbeiter</dt>
                                                <dd className="text-sm text-gray-900">{appointment.staff?.name || '-'}</dd>
                                ...
                                <div className="space-y-6">
                                    <div>
                                        <h3 className="text-lg font-medium text-gray-900 mb-4">Kundendetails</h3>
                                        <dl className="space-y-3">
                                            <div>
                                                <dt className="text-sm font-medium text-gray-500">Name</dt>
                                                <dd className="text-sm text-gray-900">
        ...
        const CallDetailPage = () => {
            ...
            const loadCall = async () => {
                try {
                    ...
                    showToast('Fehler beim Laden des Anrufs', 'error');
                } finally {
                    setLoading(false);
                }
            };
            ...
            if (!call) {
                return (
                    <div className="text-center py-12">
                        <h3 className="text-lg font-medium text-gray-900">Anruf #{id} nicht gefunden</h3>
                        <p className="text-gray-600 mt-2">Der angeforderte Anruf existiert nicht oder Sie haben keine Berechtigung.</p>
        ...
        const CustomerDetailPage = () => {
            const { id } = useParams();
            const navigate = useNavigate();
            // Will be implemented similar to CustomerDetailView but as full page
            return (
                <div>
                    <nav className="mb-6">
                        <ol className="flex items-center space-x-2">
                            ...
                            <li className="text-gray-500">/</li>
                            <li className="text-gray-900">Kunde #{id}</li>
                        </ol>
                    </nav>
        ...
        // Placeholder components for other detail pages
        const CompanyDetailPage = () => {
            ...
            return (
                <div>
                    ...
                    <button onClick={() => navigate('/companies')}>Zurück</button>
                </div>
            );
        };
        ...
        const BranchDetailPage = () => {
            ...
            return (
                <div>
                    <h2>Branch Details #{id}</h2>
                    <button onClick={() => navigate('/branches')}>Zurück</button>
                </div>
            );
        };
        ...
        const StaffDetailPage = () => {
            ...
            return (
                <div>
                    <h2>Staff Details #{id}</h2>
                    <button onClick={() => navigate('/staff')}>Zurück</button>
                </div>
            );
        };
        ...
        const ServiceDetailPage = () => {
            ...
            return (
                <div>
                    ...
                    <button onClick={() => navigate('/services')}>Zurück</button>
                </div>
            );
        };
        ...
        const App = () => {
            ...
            const currentPath = router ? router.currentPath : '/';
            
            const renderView = () => {
                // Detail pages
                if (currentPath.startsWith('/appointments/') && currentPath !== '/appointments') {
                    return <AppointmentDetailPage />;
                }
                if (currentPath.startsWith('/calls/') && currentPath !== '/calls') {
                    return <CallDetailPage />;
                }
                if (currentPath.startsWith('/customers/') && currentPath !== '/customers') {
                    return <CustomerDetailPage />;
                }
                if (currentPath.startsWith('/companies/') && currentPath !== '/companies') {
                    return <CompanyDetailPage />;
                }
                if (currentPath.startsWith('/branches/') && currentPath !== '/branches') {
                    return <BranchDetailPage />;
                }
                if (currentPath.startsWith('/staff/') && currentPath !== '/staff') {
