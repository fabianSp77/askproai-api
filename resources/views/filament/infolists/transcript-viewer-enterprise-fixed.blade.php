...
document.addEventListener('alpine:init', () => {
    Alpine.data('transcriptViewerEnterprise', (callId, sentenceSentiments, showTranslateToggle, transcriptData) => ({
        callId: callId,
        ...
        init() {
            console.log('Transcript viewer initialized with data:', {
                callId: this.callId,
                sentenceSentiments: this.sentenceSentiments.length,
                transcriptObject: this.transcriptObject.length
            });
