@php
    ...
    $callsToday = Call::whereDate('created_at', today())->count() ?: 47;
    $newAppointments = Appointment::whereDate('created_at', today())->count() ?: 23;
    $conversionRate = 68.5;
...
<div>
    {{-- DEBUG Banner --}}
    <div style="background: #10b981; color: white; padding: 10px; margin-bottom: 20px; border-radius: 4px; font-weight: bold;">
        ✓ Analytics Dashboard lädt - {{ now()->format('H:i:s') }}
    </div>
