        ...
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Real-time call tracking and queue status</p>
                </div>
                <div class="flex items-center space-x-4">
                    ...
                    {{-- Actions --}}
                    <button wire:click="toggleExpanded" class="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
                        @if($isExpanded)
                            <x-heroicon-m-chevron-up class="w-5 h-5 text-gray-500 dark:text-gray-400" />
                        @else
                            <x-heroicon-m-chevron-down class="w-5 h-5 text-gray-500 dark:text-gray-400" />
                        @endif
                    </button>
                </div>
            </div>
        ...
        <div class="p-6">
                            ...
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    ...
                                    <div class="flex items-center space-x-3 mb-3">
                                        ...
                                        <span class="text-sm text-gray-500 dark:text-gray-400">• {{ $call['branch'] }}</span>
                            ...
                            <div class="mt-3">
                                <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-1.5">
                                    <div class="bg-blue-600 h-1.5 rounded-full transition-all duration-1000" 
                                         style="width: {{ min(($call['duration_seconds'] / 300) * 100, 100) }}%"></div>
                                </div>
                            </div>
                        </div>
                    @endforeach
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">No active calls at the moment</p>
                </div>
            @endif
        </div>
                ...
                <div class="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-6 text-sm">
                            <div>
                                <span class="text-amber-600 dark:text-amber-400">Avg Wait:</span>
                                <span class="font-medium text-amber-800 dark:text-amber-200">
                                    {{ gmdate('i:s', $queueMetrics['avg_wait_time']) }}
                                </span>
                            </div>
                            <div>
                                <span class="text-amber-600 dark:text-amber-400">Longest:</span>
                                <span class="font-medium text-amber-800 dark:text-amber-200">
