<x-filament-panels::page>
            ...
            [
                ...
                'fields' => [
                    ...
                    [
                        ...
                        'min' => '0',
                        'max' => '480',
                        'value' => $record->break_duration_minutes ?? '60',
            ...
            [
                ...
                'fields' => [
                    [
                        ...
                        'value' => $record->break_start_time ?? '12:00',
                    ...
                    [
                        ...
                        'value' => $record->break_end_time ?? '13:00',
                    ...
                    [
                        ...
                        'value' => $record->available_for_appointments ?? true,
    ...
    <x-admin.flowbite-form
        ...
        description="Update working hours for staff member"
        action="{{ url('/admin/working-hours/' . $record->id, $record) }}"
        method="PUT"
        :sections="$sections"
        submitLabel="Update Working Hours"
