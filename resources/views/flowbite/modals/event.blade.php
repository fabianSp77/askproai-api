          ...
          <form action="#">
            <div class="mb-4 grid gap-4">
                ...
                <div class="w-full rounded-lg border border-gray-200 bg-gray-50 dark:border-gray-600 dark:bg-gray-700">
                  ...
                  <div class="rounded-b-lg bg-white px-4 py-2 dark:bg-gray-800">
                    <Textarea
                      ...
                      required
                      rows={{ 8 }}
                      class="border-0 bg-white px-0 text-sm focus:ring-0 dark:bg-gray-800 dark:text-white dark:placeholder:text-gray-400"
                    >
              ...
              <div>
                ...
                <Datepicker id="event-date" name="event-date" ></Datepicker>
              </div>
              <div>
                <ToggleSwitch
                  checked={{ allDay }}
              ...
              <div class="flex items-center gap-x-3">
                <Avatar.Group class="[&_img]:ring-white [&_img]:dark:ring-gray-800">
                  <Avatar
                    alt="Helene Engles"
