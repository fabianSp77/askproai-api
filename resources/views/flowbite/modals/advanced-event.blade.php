        ...
        <Modal.Body class="relative rounded-lg bg-white p-4 shadow dark:bg-gray-800 sm:p-5">
          <div class="mb-2 flex items-center justify-between pb-4">
            ...
            <button
              ...
              class="absolute right-5 top-4 ml-auto inline-flex items-center rounded-lg bg-transparent p-1.5 text-sm text-gray-400 hover:bg-gray-200 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white"
            >
              <svg
                aria-hidden
                fill="currentColor"
          ...
          <form action="#">
            <div class="mb-4 grid gap-4 sm:mb-6 md:grid-cols-2">
              <div class="space-y-4">
                <div>
                  <Label
                    htmlFor="title"
                ...
                <div>
                  ...
                  <Datepicker id="location" name="location" ></Datepicker>
                </div>
                <time
                ...
                <div class="items-center sm:flex sm:space-x-4">
                  <Avatar.Group class="mb-4 sm:mb-0 [&_img]:ring-white dark:[&_img]:ring-0">
                    <Avatar
                      alt="Helene Engels"
                ...
                <div>
                  <div class="mb-2 flex items-center">
                    <button class="rounded-lg bg-[#4285F4] px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-[#4285F4]/90 focus:outline-none focus:ring-4 focus:ring-[#4285F4]/50">
                    ...
                    <div class="ml-3 flex">
                      ...
                      >
                        <button class="ml-auto inline-flex items-center rounded-lg bg-transparent p-1.5 text-sm text-gray-500 hover:bg-gray-200 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white">
                          <svg
                            aria-hidden
                            class="h-5 w-5"
                            fill="currentColor"
                ...
                <div>
                  ...
                  <div class="flex items-center space-x-2">
                    <button class="h-6 w-6 rounded-sm bg-purple-500"></button>
                    <button class="h-6 w-6 rounded-sm bg-indigo-500"></button>
                    <button class="h-6 w-6 rounded-sm bg-primary-600"></button>
                    <button class="h-6 w-6 rounded-sm bg-pink-500"></button>
                    <button class="h-6 w-6 rounded-sm bg-teal-400"></button>
                    <button class="h-6 w-6 rounded-sm bg-green-400"></button>
                    <button class="h-6 w-6 rounded-sm bg-yellow-300"></button>
                    <button class="h-6 w-6 rounded-sm bg-orange-400"></button>
                    <button class="h-6 w-6 rounded-sm bg-red-500"></button>
                  </div>
                </div>
              </div>
              <div>
                ...
                <div class="mb-4 w-full rounded-lg border border-gray-200 bg-gray-100 dark:border-gray-600 dark:bg-gray-600">
                ...
                <div>
                  ...
                  <div class="space-y-4 sm:flex sm:space-x-4 sm:space-y-0">
                    <div class="w-full">
                      <Label htmlFor="reminder-type" class="sr-only">
                        Reminder type
                      </Label>
                    ...
                    <div class="w-full">
                      <Label htmlFor="reminder-counter" class="sr-only">
                        Counter
                      </Label>
                      <TextInput
                        defaultValue="4"
                    ...
                    <div class="w-full">
                      <Label htmlFor="reminder-length-type" class="sr-only">
                        Length
                      </Label>
                      <Select
            ...
            <div class="flex items-center space-x-4">
              ...
              <Button
                ...
                class="[&>span]:border-red-600 [&>span]:px-5 [&>span]:py-2.5"
              >
                <svg
                  fill="currentColor"
                  viewBox="0 0 20 20"
