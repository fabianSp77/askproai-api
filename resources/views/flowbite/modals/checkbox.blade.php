...
@section('content')
      ...
      >
        <Modal.Body class="relative rounded-lg bg-white p-4 shadow dark:bg-gray-800 sm:p-5">
          ...
          <div
            class="mb-4 rounded-lg bg-gray-100 p-4 text-left text-sm text-gray-500 dark:bg-gray-700 dark:text-gray-400 sm:mb-5"
            role="alert"
          >
            <div class="flex">
              <Checkbox
                id="confirm-checkbox"
                class="mt-1 h-4 w-4 rounded border-gray-300 bg-gray-50 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-500 dark:bg-gray-600 dark:ring-offset-gray-700 dark:focus:ring-primary-600"
                required
              ></Checkbox>
              <Label
