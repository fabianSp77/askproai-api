    ...
    <section class="bg-white dark:bg-gray-900">
      <div class="mx-auto max-w-2xl px-4 py-8 lg:py-16">
        <form>
          ...
          <div class="mb-4 grid gap-4 sm:mb-8 md:grid-cols-2 md:gap-6">
            <div class="sm:col-span-2">
              ...
              <div class="w-full items-center sm:flex">
                <Avatar
                  ...
                  rounded
                  size="lg"
                  class="mb-4 justify-start sm:mb-0 sm:mr-4 sm:justify-center [&_img]:max-w-none"
                ></Avatar>
                <div class="w-full">
                  <FileInput
            ...
            <div>
              <Label htmlFor="last-name" class="mb-2 block dark:text-white">
                Last Name
              </Label>
              <TextInput
                defaultValue="Engels"
            ...
            <div>
              <Label htmlFor="email" class="mb-2 block dark:text-white">
                Email
              </Label>
              <TextInput
            ...
            <div>
              <Label htmlFor="job-title" class="mb-2 block dark:text-white">
                Job Title
              </Label>
              <TextInput
            ...
            <div>
              <Label htmlFor="password" class="mb-2 block dark:text-white">
                Password
              </Label>
              <TextInput
                id="password"
            ...
            <div class="sm:col-span-2">
              <Label htmlFor="biography" class="mb-2 block dark:text-white">
                Biography
              </Label>
              <div class="w-full rounded-lg border border-gray-200 bg-gray-50 dark:border-gray-600 dark:bg-gray-700">
                ...
                <div class="rounded-b-lg bg-gray-50 px-4 py-2 dark:bg-gray-800 dark:[&>textarea]:bg-gray-800">
                  <Textarea
            ...
            <div>
              <p class="mb-2 block dark:text-white">Assign Role</p>
              <div class="flex items-center space-x-4">
                <div class="flex items-center">
                  <Checkbox id="inline-checkbox" name="inline-checkbox" ></Checkbox>
                  <Label
                ...
                <div class="flex items-center">
                  <Checkbox id="inline-2-checkbox" name="inline-2-checkbox" ></Checkbox>
                  <Label
          ...
          <div class="mb-4 grid gap-4 sm:mb-8 md:grid-cols-2 md:gap-6">
            <div>
              <Label htmlFor="country" class="mb-2 block dark:text-white">
                Country
              </Label>
            ...
            <div>
              <Label htmlFor="city" class="mb-2 block dark:text-white">
                City
              </Label>
            ...
            <div>
              <Label htmlFor="address" class="mb-2 block dark:text-white">
                Address
              </Label>
              <TextInput
            ...
            <div>
              <Label htmlFor="zip" class="mb-2 block dark:text-white">
                ZIP
              </Label>
              <TextInput
            ...
            <div>
              <Label htmlFor="timezone" class="mb-2 block dark:text-white">
                Timezone
              </Label>
              <TextInput
                defaultValue="GMT+3"
            ...
            <div>
              <Label htmlFor="linkedin" class="mb-2 block dark:text-white">
                Linkedin URL
              </Label>
              <TextInput
            ...
            <div>
              <Label htmlFor="facebook" class="mb-2 block dark:text-white">
                Facebook
              </Label>
              <TextInput
            ...
            <div>
              <Label htmlFor="github" class="mb-2 block dark:text-white">
                Github
              </Label>
              <TextInput
                defaultValue="@helene"
            ...
            <div>
              <Label htmlFor="dribbble" class="mb-2 block dark:text-white">
                Dribbble
              </Label>
              <TextInput
            ...
            <div>
              <Label htmlFor="instagram" class="mb-2 block dark:text-white">
                Instagram
              </Label>
              <TextInput
          ...
          <div class="mt-3 flex items-center space-x-4">
            <Button type="submit" class="[&>span]:px-5 [&>span]:py-2.5">
              Update user
            </Button>
            <Button
              color="failure"
