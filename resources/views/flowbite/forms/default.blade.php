        ...
        <form>
          <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
            <div class="sm:col-span-2">
              <Label htmlFor="name" class="mb-2 block dark:text-white">
                Product Name
              </Label>
              <TextInput
            ...
            <div class="w-full">
              <Label htmlFor="brand" class="mb-2 block dark:text-white">
                Brand
              </Label>
              <TextInput
                defaultValue="Apple"
            ...
            <div class="w-full">
              <Label htmlFor="price" class="mb-2 block dark:text-white">
                Price
              </Label>
              <TextInput
                defaultValue="2999"
            ...
            <div>
              <Label htmlFor="category" class="mb-2 block dark:text-white">
                Category
              </Label>
              <Select id="category">
