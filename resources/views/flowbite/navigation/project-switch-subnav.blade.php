...
@section('content')
    ...
    <header class="antialiased">
      ...
      >
        <div class="border-gray-200 bg-white px-4 py-2.5 dark:bg-gray-900 lg:px-6">
          <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
              ...
              <form action="#" method="GET" class="hidden lg:block lg:pl-2">
                <Label htmlFor="topbar-search" class="sr-only">
                  Search
                </Label>
            ...
            <div class="flex items-center justify-between lg:order-2">
              ...
              >
                ...
                <Dropdown.Item class="text-gray-500 dark:text-gray-400">
                  My profile
                </Dropdown.Item>
                <Dropdown.Item class="text-gray-500 dark:text-gray-400">
                  Account settings
              ...
              <Navbar.Toggle class="ml-3" ></Navbar>
            </div>
          </div>
        </div>
        <nav class="bg-gray-50 dark:bg-gray-800">
          <div class="flex flex-wrap items-center justify-between p-4 sm:pb-3 lg:px-6">
            <div class="mb-4 flex items-center sm:mb-0">
              <Dropdown
                ...
                label={{ 
                    ...
                    <div class="mr-2 flex items-center">
                      <img
                        src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png"
                        class="mr-2 h-7 w-7 rounded-full"
                        alt=""
                      ></img>
                      <div class="text-left">
              ...
              >
                ...
                >
                  <div class="text-left">
                    <div class="mb-0.5 text-sm font-medium leading-none text-gray-900 dark:text-white">
                      Company
                    </div>
              ...
              <svg
                class="mx-4 h-3 w-3 text-gray-500 dark:text-gray-400"
                aria-hidden
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 6 10"
            ...
            <div class="grid w-full grid-cols-2 gap-3 sm:flex sm:w-auto sm:items-center">
              <Button class="whitespace-nowrap [&>span]:text-xs">
                Open app
              </Button>
              <Dropdown
                color="gray"
              ...
              >
                <Dropdown.Item>
                  <svg
                    class="mr-2 h-4 w-4 text-gray-500 dark:text-gray-300"
                    aria-hidden
                    fill="currentColor"
                    viewBox="0 0 20 20"
                    xmlns="http://www.w3.org/2000/svg"
