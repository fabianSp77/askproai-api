...
@section('content')
    ...
    <header class="antialiased">
      ...
      >
        <div class="w-full px-4 py-3.5 md:px-6">
          <div class="flex w-full flex-wrap items-center justify-between">
            ...
            <div class="flex items-center md:order-2">
              ...
              <span class="mx-2 h-5 w-px bg-gray-200 dark:bg-gray-600 md:inline"></span>
              <Dropdown
                inline
                label={{ 
              ...
              <Tooltip content="View FAQ">
                <button class="hidden rounded-lg p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-900 focus:ring-4 focus:ring-gray-300 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-600 md:inline-block">
              ...
              <Navbar.Toggle class="items-center rounded-lg p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-900 focus:ring-4 focus:ring-gray-300 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-600 md:hidden" ></Navbar>
            </div>
          </div>
        </div>
        <Navbar.Collapse
        ...
        >
          <div class="[&>li]:md:hidden">
            <Navbar.Link>
              <Dropdown
                inline
                label={{ 
                  <span class="flex w-full items-center justify-between text-sm font-medium text-gray-900 dark:text-white md:p-0 md:hover:underline">
                    <span>
                      Account&nbsp;
                    ...
                    <svg
                      class="h-2.5 w-2.5 text-gray-500 dark:text-gray-400"
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 6 10"
          ...
          <Navbar.Link
            href="#"
            class="px-4 py-2.5 text-sm font-medium hover:underline dark:text-gray-100 md:mr-8"
          >
            Home
          </Navbar.Link>
          <Navbar.Link
          ...
          <Navbar.Link
            href="#"
            class="border-b-0 px-4 py-2.5 text-sm font-medium hover:underline dark:text-gray-100"
          >
            Support
          </Navbar.Link>
        </Navbar.Collapse>
