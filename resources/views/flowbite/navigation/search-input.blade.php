...
@section('content')
    ...
    <header>
      <Navbar
        fluid
        class="border-gray-200 bg-white px-0 py-2.5 antialiased dark:bg-gray-900"
      >
        <div class="flex w-full flex-wrap items-center justify-between">
          <div class="flex w-full items-center justify-start px-4 lg:px-6">
            <a href="https://flowbite.com" class="mr-6 flex xl:mr-8">
              <img
            ...
            <div class="w-full items-center justify-between lg:order-1 lg:ml-6 lg:flex">
              ...
              <div class="flex items-center justify-end lg:order-2 lg:justify-between">
                <Dropdown
                  inline
                  label={{ 
                ...
                <span class="mx-2 hidden h-5 w-px bg-gray-200 dark:bg-gray-600 md:inline"></span>
                <Dropdown
                  inline
                  label="flowbite.com"
                  placement="bottom"
                ...
                >
                  <ul class="space-y-1 p-3 text-sm text-gray-700 dark:text-gray-200">
                    <li>
                      <div class="flex rounded p-2 hover:bg-gray-100 dark:hover:bg-gray-600">
                        <div class="flex h-5 items-center">
                          <Radio id="helper-radio-4" name="helper-radio" ></Radio>
                        </div>
                    ...
                    <li>
                      <div class="flex rounded p-2 hover:bg-gray-100 dark:hover:bg-gray-600">
                        <div class="flex h-5 items-center">
                          <Radio id="helper-radio-5" name="helper-radio" ></Radio>
                        </div>
                        <div class="ml-2 text-sm">
                          <Label
                    ...
                    <li>
                      <div class="flex rounded p-2 hover:bg-gray-100 dark:hover:bg-gray-600">
                        <div class="flex h-5 items-center">
                          <Radio id="helper-radio-6" name="helper-radio" ></Radio>
                        </div>
                        <div class="ml-2 text-sm">
                          <Label
                ...
                <span class="ml-2 mr-4 hidden h-5 w-px bg-gray-200 dark:bg-gray-600 md:inline"></span>
                <Dropdown
                  inline
                  label={{ 
          ...
          <div class="mt-4 w-full bg-white dark:bg-gray-900">
            <form class="w-full px-4 lg:max-w-xl lg:px-6">
              <div class="flex">
                <Label
                ...
                >
                  <Dropdown.Item>https only</Dropdown.Item>
                  <Dropdown.Item>http</Dropdown.Item>
                  <Dropdown.Item>http + https</Dropdown.Item>
                </Dropdown>
                <div class="relative flex w-full">
                  <TextInput
                    ...
                    required
                    type="search"
                    class="w-full [&_input]:rounded-r-none [&_input]:md:rounded-l-none"
                  ></TextInput>
                  <Dropdown
                    color="gray"
                    label={{ 
                      
                        <span class="hidden md:inline">Subdomains</span>
                        <svg
                          aria-hidden="true"
                  ...
                  >
                    <Dropdown.Item>Subfolders</Dropdown.Item>
                    <Dropdown.Item>Subdomains</Dropdown.Item>
                    <Dropdown.Item>Full domain</Dropdown.Item>
                  </Dropdown>
                  <button
                    type="submit"
                    class="rounded-r-lg border border-primary-700 bg-primary-700 p-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                  >
                    <svg
                      class="h-4 w-4"
                      aria-hidden
            ...
            <Navbar.Collapse
              ...
              class="md:mt-4 lg:hidden"
            >
              <Navbar.Link class="px-4">
                <Dropdown
                  inline
                  label={{ 
                    <span>
              ...
              <Navbar.Link
                href="#"
                class="px-4 text-sm font-medium dark:text-white"
              >
                Home
              </Navbar.Link>
              <Navbar.Link
