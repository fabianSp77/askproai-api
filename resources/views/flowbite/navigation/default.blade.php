      ...
      <Navbar class="bg-white dark:bg-gray-800">
        <div class="flex w-full flex-wrap items-center justify-between">
          <div class="flex items-center justify-start">
            ...
            <button class="mr-2 cursor-pointer rounded-lg p-2 text-gray-600 hover:bg-gray-100 hover:text-gray-900 focus:bg-gray-100 focus:ring-2 focus:ring-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:bg-gray-700 dark:focus:ring-gray-700 lg:hidden">
              <svg
                class="h-[18px] w-[18px]"
                aria-hidden
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="flex items-center gap-x-2 lg:order-2">
            <Button size="sm" class="hidden md:block [&_span]:text-xs">
              <svg
                aria-hidden
            ...
            <button
              ...
              type="button"
              class="rounded-lg p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:hidden"
            >
