...
@section('content')
    ...
    <header class="flex flex-col antialiased">
      ...
      >
        <div class="order-1 px-4 py-2.5 lg:px-6">
          <div class="flex items-center justify-between">
            ...
            <ul class="mt-0 hidden w-full flex-col justify-center text-sm font-medium text-gray-500 dark:text-gray-400 md:flex md:flex-row">
              <li class="block border-b dark:border-gray-700 md:inline md:border-b-0">
                <a
                  href="#"
                  class="block rounded-lg px-4 py-3 hover:text-gray-900 dark:hover:text-white"
                >
                  Home
                </a>
              </li>
            ...
            <div class="ml-4 flex shrink-0 items-center justify-between lg:order-2">
              <Button class="mr-3 hidden md:inline">
                <svg
              ...
              >
                    ...
                    <div class="shrink-0">
                      ...
                      <div class="absolute -mt-5 ml-6 flex h-5 w-5 items-center justify-center rounded-full border border-white bg-primary-700 dark:border-gray-700">
                        <svg
                          ...
                          viewBox="0 0 18 18"
                        >
                          <path d="M15.977.783A1 1 0 0 0 15 0H3a1 1 0 0 0-.977.783L.2 9h4.239a2.99 2.99 0 0 1 2.742 1.8 1.977 1.977 0 0 0 3.638 0A2.99 2.99 0 0 1 13.561 9H17.8L15.977.783ZM6 2h6a1 1 0 1 1 0 2H6a1 1 0 0 1 0-2Zm7 5H5a1 1 0 0 1 0-2h8a1 1 0 1 1 0 2Z" ></path>
                          <path d="M1 18h16a1 1 0 0 0 1-1v-6h-4.439a.99.99 0 0 0-.908.6 3.978 3.978 0 0 1-7.306 0 .99.99 0 0 0-.908-.6H0v6a1 1 0 0 0 1 1Z" ></path>
                        </svg>
                      </div>
                    </div>
                ...
                <a
                  href="#"
                  class="block border-t border-gray-200 bg-gray-50 py-2 text-center text-base font-medium text-gray-900 hover:bg-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:hover:underline"
                >
              ...
              >
                ...
                <div class="grid grid-cols-3 gap-4 border-t p-4 dark:border-gray-600">
                  <a
                    href="#"
                  ...
                  >
                    <svg
                      ...
                      viewBox="0 0 16 20"
                    >
                      <path d="M7 11H5v1h2v-1Zm4 3H9v1h2v-1Zm-4 0H5v1h2v-1ZM5 5V.13a2.98 2.98 0 0 0-1.293.749L.88 3.707A2.98 2.98 0 0 0 .13 5H5Z" ></path>
                      <path d="M14.066 0H7v5a2 2 0 0 1-2 2H0v11a1.97 1.97 0 0 0 1.934 2h12.132A1.97 1.97 0 0 0 16 18V2a1.97 1.97 0 0 0-1.934-2ZM13 16a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1v-6a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1v6Zm-1-8H9a1 1 0 0 1 0-2h3a1 1 0 1 1 0 2Zm0-3H9a1 1 0 0 1 0-2h3a1 1 0 1 1 0 2Z" ></path>
                      <path d="M11 11H9v1h2v-1Z" ></path>
                    </svg>
                    <div class="text-sm font-medium text-gray-900 dark:text-white">
                      Billing
                    </div>
              ...
              >
                ...
                <Dropdown.Item>
                  <svg
                    ...
                    viewBox="0 0 20 20"
                  >
                    <path d="m1.56 6.245 8 3.924a1 1 0 0 0 .88 0l8-3.924a1 1 0 0 0 0-1.8l-8-3.925a1 1 0 0 0-.88 0l-8 3.925a1 1 0 0 0 0 1.8Z" ></path>{{ " " }}
                    <path d="M18 8.376a1 1 0 0 0-1 1v.163l-7 3.434-7-3.434v-.163a1 1 0 0 0-2 0v.786a1 1 0 0 0 .56.9l8 3.925a1 1 0 0 0 .88 0l8-3.925a1 1 0 0 0 .56-.9v-.786a1 1 0 0 0-1-1Z" ></path>{{ " " }}
                    <path d="M17.993 13.191a1 1 0 0 0-1 1v.163l-7 3.435-7-3.435v-.163a1 1 0 1 0-2 0v.787a1 1 0 0 0 .56.9l8 3.925a1 1 0 0 0 .88 0l8-3.925a1 1 0 0 0 .56-.9v-.787a1 1 0 0 0-1-1Z" ></path>{{ " " }}
                  </svg>
                  Collections
                </Dropdown.Item>
                <Dropdown.Item>
                  <div class="flex w-full items-center justify-between">
                    <span class="flex items-center">
                      <svg
                        ...
                        viewBox="0 0 20 20"
                      >
                        <path d="m7.164 3.805-4.475.38L.327 6.546a1.114 1.114 0 0 0 .63 1.89l3.2.375 3.007-5.006ZM11.092 15.9l.472 3.14a1.114 1.114 0 0 0 1.89.63l2.36-2.362.38-4.475-5.102 3.067Zm8.617-14.283A1.613 1.613 0 0 0 18.383.291c-1.913-.33-5.811-.736-7.556 1.01-1.98 1.98-6.172 9.491-7.477 11.869a1.1 1.1 0 0 0 .193 1.316l.986.985.985.986a1.1 1.1 0 0 0 1.316.193c2.378-1.3 9.889-5.5 11.869-7.477 1.746-1.745 1.34-5.643 1.01-7.556Zm-3.873 6.268a2.63 2.63 0 1 1-3.72-3.72 2.63 2.63 0 0 1 3.72 3.72Z" ></path>
                      </svg>
                      Pro version
                    </span>
                    <svg
        ...
        <Navbar.Collapse class="order-3 border-t bg-white px-4 py-2.5 shadow-sm dark:border-gray-800 dark:bg-gray-900 md:order-2 lg:px-6">
          <div class="flex w-full flex-col items-center justify-between md:flex-row">
            <ul class="order-2 mt-0 flex w-full flex-col rounded-lg border border-gray-200 bg-gray-50 text-sm font-medium dark:border-gray-700 dark:bg-gray-800 md:order-1 md:flex-row md:rounded-none md:border-0 md:bg-white dark:md:bg-gray-900">
              <li>
                <a
                  href="#"
                  class="block rounded-lg px-4 py-3 text-primary-600 hover:bg-gray-50 hover:text-primary-700 focus:ring-4 focus:ring-gray-200 dark:text-primary-500 dark:hover:bg-gray-800 dark:focus:ring-gray-700"
                  aria-current="page"
                >
                  Projects
                </a>
              ...
              <li>
                <a
                  href="#"
                  class="block rounded-lg px-4 py-3 text-gray-500 hover:bg-gray-50 hover:text-gray-900 focus:ring-4 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white dark:focus:ring-gray-700"
                >
                  Sales
                </a>
              </li>
            ...
            <form class="order-1 mb-4 flex w-full items-center justify-end md:order-2 md:mb-0 md:ml-4 md:max-w-sm">
              ...
              />
              <Button type="submit" class="ml-3 [&>span]:py-3">
                <svg
                  class="h-4 w-4"
                  aria-hidden
                  xmlns="http://www.w3.org/2000/svg"
