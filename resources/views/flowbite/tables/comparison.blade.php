    ...
    <section class="bg-gray-50 py-3 dark:bg-gray-900 sm:py-5">
      <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
        <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-900 sm:rounded-lg">
          <div class="flex flex-col items-start justify-between space-y-3 p-4 dark:bg-gray-800 md:flex-row md:items-center md:space-x-4 md:space-y-0">
            ...
            <div class="flex w-auto shrink-0 flex-row items-center justify-end space-x-3">
              <Button>
                <svg
          ...
          <div class="overflow-x-auto">
            <Table class="w-full text-left text-sm text-gray-500 dark:text-gray-400">
              <Table.Head class="text-xs text-gray-900 dark:text-white">
                <Table.HeadCell
                  scope="col"
                  class="px-4 py-3 dark:bg-transparent"
                ></Table>
                <Table.HeadCell
                  scope="col"
                  class="px-4 py-3 dark:bg-transparent"
                >
                  <div class="text-lg">
                    <img
                      ...
                      class="h-32 w-auto"
                    ></img>
                    <div class="mt-4">Xbox Series S</div>
                  </div>
                </Table.HeadCell>
                <Table.HeadCell
                  scope="col"
                ...
                >
                  <div class="text-lg">
                    <img
                      ...
                      class="h-32 w-auto"
                    ></img>
                    <div class="mt-4">PlayStation 5</div>
                  </div>
                </Table.HeadCell>
                <Table.HeadCell
                  scope="col"
                ...
                >
                  <div class="text-lg">
                    <img
                      ...
                      class="h-32 w-auto"
                    ></img>
                    <div class="mt-4">Xbox Series X</div>
                  </div>
                </Table.HeadCell>
              </Table.Head>
              <Table.Body>
                <Table.Row class="border-b bg-gray-50 dark:border-gray-700 dark:bg-gray-800">
                  <Table.Cell
                    colSpan={{ 4 }}
                    scope="row"
                ...
                <Table.Row class="border-b dark:border-gray-700">
                  ...
                  <Table.Cell class="whitespace-nowrap px-4 py-3 text-red-500">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 20 20"
                      fill="currentColor"
                  ...
                  <Table.Cell class="whitespace-nowrap px-4 py-3 font-medium text-green-500">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 20 20"
                      fill="currentColor"
                ...
                <Table.Row class="border-b dark:border-gray-600">
                  <Table.Cell
                    scope="row"
                    class="whitespace-nowrap px-4 py-3 font-normal"
                  >
                ...
                <Table.Row>
                  <Table.Cell scope="row" class="px-4 py-3" ></Table>
                  <Table.Cell class="whitespace-nowrap px-4 py-6 font-medium text-gray-900 dark:text-white">
                    <Button>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
