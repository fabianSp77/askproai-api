      ...
      <div class="mx-auto max-w-screen-2xl px-4 lg:px-12">
        <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
          ...
          <div class="overflow-x-auto">
            <Table class="[&_*]:whitespace-nowrap">
              <Table.Head>
                <Table.HeadCell
                  scope="col"
              ...
              <Table.Body>
                <Table.Row class="border-b hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-700">
                  ...
                  <Table.Cell class="px-4 py-2">$3.2M</Table.Cell>
                  <Table.Cell class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 dark:text-white">
                    Just now
                  </Table.Cell>
                </Table.Row>
                <Table.Row class="border-b hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-700">
                  ...
                  <Table.Cell class="px-4 py-2">$785K</Table.Cell>
                  <Table.Cell class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 dark:text-white">
                    This week
                  </Table.Cell>
                </Table.Row>
                ...
                <Table.Row class="border-b hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-700">
                  ...
                  <Table.Cell class="px-4 py-2">$425K</Table.Cell>
                  <Table.Cell class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 dark:text-white">
                    Just now
                  </Table.Cell>
                </Table.Row>
                <Table.Row class="border-b hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-700">
                  ...
                  <Table.Cell class="px-4 py-2">$345K</Table.Cell>
                  <Table.Cell class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 dark:text-white">
                    This week
                  </Table.Cell>
                </Table.Row>
                <Table.Row class="border-b hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-700">
                  ...
                  <Table.Cell class="px-4 py-2">$4.2M</Table.Cell>
                  <Table.Cell class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 dark:text-white">
                    This week
                  </Table.Cell>
                </Table.Row>
                <Table.Row class="border-b hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-700">
                  ...
                  <Table.Cell class="px-4 py-2">$2.27M</Table.Cell>
                  <Table.Cell class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 dark:text-white">
                    Just now
                  </Table.Cell>
                </Table.Row>
                <Table.Row class="border-b hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-700">
                  ...
                  <Table.Cell class="px-4 py-2">$45K</Table.Cell>
                  <Table.Cell class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 dark:text-white">
                    2 weeks ago
                  </Table.Cell>
                </Table.Row>
                <Table.Row class="border-b hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-700">
                  ...
                  <Table.Cell class="px-4 py-2">
                    <Badge class="w-fit">Photo/Video</Badge>
                  </Table.Cell>
                  <Table.Cell class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 dark:text-white">
                    <div class="flex items-center">
                      <div class="mr-2 inline-block h-4 w-4 rounded-full bg-orange-400"></div>
                  ...
                  <Table.Cell class="px-4 py-2">$1.52M</Table.Cell>
                  <Table.Cell class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 dark:text-white">
                    3 weeks ago
                  </Table.Cell>
                </Table.Row>
                <Table.Row class="border-b hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-700">
                  ...
                  <Table.Cell class="px-4 py-2">
                    <Badge class="w-fit">TV/Monitor</Badge>
                  </Table.Cell>
                  <Table.Cell class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 dark:text-white">
                    <div class="flex items-center">
                      <div class="mr-2 inline-block h-4 w-4 rounded-full bg-green-400"></div>
                  ...
                  <Table.Cell class="px-4 py-2">$1.2M</Table.Cell>
                  <Table.Cell class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 dark:text-white">
                    Just now
                  </Table.Cell>
                </Table.Row>
