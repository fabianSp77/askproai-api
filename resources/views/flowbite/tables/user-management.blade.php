        ...
        <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
          <div class="divide-y px-4 dark:divide-gray-700">
            <div class="flex flex-col space-y-3 py-3 md:flex-row md:items-center md:justify-between md:space-x-4 md:space-y-0">
              ...
              <div class="flex shrink-0 flex-col items-start space-y-3 md:flex-row md:items-center md:space-x-3 md:space-y-0 lg:justify-end">
                <Button color="gray" size="sm" class="[&_span]:text-xs">
                  <svg
            ...
            <div class="flex flex-col items-stretch justify-between space-y-3 py-4 md:flex-row md:items-center md:space-y-0">
              ...
              <Button.Group class="flex-col md:flex-row">
                <Button
                  color="gray"
                  class="w-full rounded-b-none rounded-t-lg dark:bg-gray-700 dark:hover:bg-gray-600 md:w-fit md:rounded-r-none md:rounded-bl-lg"
                >
                  Suspend all
                </Button>
                <Button
                  color="gray"
                  class="w-full dark:bg-gray-700 dark:hover:bg-gray-600 md:w-fit"
                >
                  Archive all
                </Button>
                <Button
                  color="gray"
                  class="w-full rounded-t-none rounded-bl-lg dark:bg-gray-700 dark:hover:bg-gray-600 md:w-fit md:rounded-bl-none md:rounded-tr-lg"
                >
                  Delete all
                </Button>
              </Button.Group>
              ...
              <Table.Body>
                <Table.Row class="border-b hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-700">
                  ...
                  <Table.Cell class="px-4 py-2">
                    <Badge class="w-fit whitespace-nowrap">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <Table.Cell class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 dark:text-white">
                    <div class="flex items-center">
                      <div class="mr-2 h-3 w-3 rounded-full border bg-green-500"></div>
                      Active
                    </div>
                  </Table.Cell>
                    ...
                    <div class="flex items-center space-x-1.5">
                      ...
                      >
                        <svg
                          ...
                          aria-hidden
                        >
                          <path d="m6.44 7 .329-2.156H4.683V3.437c0-.609.28-1.171 1.218-1.171h.961V.414S5.995.25 5.175.25c-1.711 0-2.836 1.055-2.836 2.93v1.664H.417V7h1.922v5.25h2.344V7H6.44Z" ></path>
                        </svg>
                      </a>
                      <a
                        class="transition hover:text-gray-900 dark:hover:text-white"
                      ...
                      >
                        <svg
                          ...
                          aria-hidden
                        >
                          <path d="M12.188 6.203c0-.375-.047-.656-.094-.96H6.563v1.991h3.28c-.116.868-.984 2.508-3.28 2.508-1.993 0-3.61-1.64-3.61-3.68 0-3.257 3.844-4.757 5.906-2.765l1.594-1.524A5.637 5.637 0 0 0 6.563.25 5.797 5.797 0 0 0 .75 6.063a5.782 5.782 0 0 0 5.813 5.812c3.351 0 5.625-2.344 5.625-5.672Z" ></path>
                        </svg>
                      </a>
                    </div>
                  </Table.Cell>
                  <Table.Cell class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 dark:text-white">
                    <PromoteToggleSwitch ></PromoteToggleSwitch>
                  </Table.Cell>
                  <Table.Cell class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 dark:text-white">
                    <div class="flex items-center">
                      <svg
                  ...
                  <Table.Cell class="px-4 py-2">20 Nov 2022</Table.Cell>
                  <Table.Cell class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 dark:text-white">
                    <Dropdown
                      inline
                      label={{ 
                ...
                <Table.Row class="border-b hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-700">
                  ...
                  <Table.Cell class="px-4 py-2">
                    <Badge color="gray" class="w-fit">
                      <HiEye class="mr-1 h-3.5 w-3.5" ></HiEye>
                      Viewer
                    </Badge>
                  </Table.Cell>
                  <Table.Cell class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 dark:text-white">
                  ...
                  <Table.Cell class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 dark:text-white">
                    <div class="flex items-center">
                      <HiArrowDown class="mr-1 h-4 w-4 text-red-500" ></HiArrowDown>
                      3.9
                    </div>
                  </Table.Cell>
                  <Table.Cell class="px-4 py-2">23 Nov 2022</Table.Cell>
                  <Table.Cell class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 dark:text-white">
                    <Dropdown
                      inline
                      label={{ 
                ...
                <Table.Row class="border-b hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-700">
                  ...
                  <Table.Cell class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 dark:text-white">
                    <div class="flex items-center">
                      <div class="mr-2 h-3 w-3 rounded-full border bg-red-500" ></div>
                      Inactive
                    </div>
                  </Table.Cell>
                  <Table.Cell class="whitespace-nowrap px-4 py-2">
                  ...
                  <Table.Cell class="px-4 py-2">19 Nov 2022</Table.Cell>
                  <Table.Cell class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 dark:text-white">
                    <Dropdown
                      inline
                      label={{ 
                ...
                <Table.Row class="border-b hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-700">
                  ...
                  <Table.Cell class="px-4 py-2">27 Nov 2022</Table.Cell>
                  <Table.Cell class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 dark:text-white">
                    <Dropdown
                      inline
                      label={{ 
                ...
                <Table.Row class="border-b hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-700">
                  ...
                  <Table.Cell class="px-4 py-2">18 Nov 2022</Table.Cell>
                  <Table.Cell class="whitespace-nowrap px-4 py-2 font-medium text-gray-900 dark:text-white">
                    <Dropdown
                      inline
                      label={{ 
          ...
          >
            <div class="flex items-center space-x-3">
              ...
              <Select id="rows" name="rows" class="[&_select]:py-2">
