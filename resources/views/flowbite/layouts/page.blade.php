...
@section('content')
      ...
      >
        <DefaultCRUDLayout ></DefaultCRUDLayout>
      </BlockSection>
      <BlockSection
      ...
      >
        <CRUDLayoutForProductManagement ></CRUDLayoutForProductManagement>
      </BlockSection>
      <BlockSection
      ...
      >
        <CRUDLayoutWithExpandableRows ></CRUDLayoutWithExpandableRows>
      </BlockSection>
      <BlockSection
      ...
      >
        <CRUDLayoutForUserManagement ></CRUDLayoutForUserManagement>
      </BlockSection>
      <BlockSection
      ...
      >
        <CRUDLayoutWithHorizontalCards ></CRUDLayoutWithHorizontalCards>
      </BlockSection>
