      ...
      <div class="mx-auto max-w-screen-2xl px-4 lg:px-12">
        <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
          <div class="flex flex-col items-center justify-between space-y-3 border-b p-4 dark:border-gray-700 md:flex-row md:space-x-4 md:space-y-0">
            ...
            <div class="flex w-full flex-col items-center justify-end gap-3 md:w-fit md:flex-row">
              <Button
                @click="{ setShowAddNewProductModal(true) "}
              ...
              >
                <Modal.Body class="relative rounded-lg bg-white p-4 shadow dark:bg-gray-800 sm:p-5">
                  <div class="mb-4 flex items-center justify-between rounded-t border-b pb-4 dark:border-gray-600 sm:mb-5">
                    ...
                    <button
                      @click="{ setShowAddNewProductModal(false) "}
                  ...
                  <form action="#">
                      ...
                      <div class="flex w-full items-center justify-center">
                        ...
                        >
                          <div class="flex flex-col items-center justify-center pb-6 pt-5">
                            <HiCloudUpload class="mb-3 h-10 w-10 text-gray-400" ></HiCloudUpload>
                    ...
                    <div class="items-center space-y-4 sm:flex sm:space-x-4 sm:space-y-0">
                      <Button
                        type="submit"
                        size="lg"
                        class="w-full md:w-fit [&>span]:text-sm"
                      >
                        Add product
                      </Button>
                      <Button
                        ...
                        class="w-full md:w-fit [&>span]:text-sm"
                      >
                        <HiCalendar class="-ml-1 mr-1 h-5 w-5" ></HiCalendar>
                        Schedule
                      </Button>
                      <Button
                        color="gray"
                        @click="{ setShowAddNewProductModal(false) "}
                        size="lg"
                        class="w-full dark:bg-gray-700 dark:enabled:hover:bg-gray-600 md:w-fit [&>span]:text-sm [&>span]:text-gray-200 hover:[&>span]:text-gray-900 dark:[&>span]:enabled:hover:text-white"
                      >
                        <HiX class="-ml-1 mr-1 h-5 w-5" ></HiX>
                        Discard
                      </Button>
                    </div>
                  </form>
              ...
              >
                <div class="p-3">
                  ...
                  <ul class="space-y-1 text-sm">
                    <li class="flex items-center rounded-md px-2 py-1 text-sm font-medium text-gray-900 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600">
                      <Checkbox id="product" name="product" ></Checkbox>
                      <Label htmlFor="product" class="ml-2">
                        Product
                      </Label>
                    </li>
                    <li class="flex items-center rounded-md px-2 py-1 text-sm font-medium text-gray-900 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600">
                      <Checkbox id="category" name="category" ></Checkbox>
                      <Label htmlFor="category" class="ml-2">
                        Category
                      </Label>
                    </li>
                    <li class="flex items-center rounded-md px-2 py-1 text-sm font-medium text-gray-900 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600">
                      <Checkbox id="brand" name="brand" ></Checkbox>
                      <Label htmlFor="brand" class="ml-2">
                        Brand
                      </Label>
                    </li>
                    <li class="flex items-center rounded-md px-2 py-1 text-sm font-medium text-gray-900 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600">
                      <Checkbox id="price" name="price" ></Checkbox>
                      <Label htmlFor="price" class="ml-2">
                        Price
                      </Label>
                    </li>
                    <li class="flex items-center rounded-md px-2 py-1 text-sm font-medium text-gray-900 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600">
                      <Checkbox defaultChecked id="stock" name="stock" ></Checkbox>
                      <Label htmlFor="stock" class="ml-2">
                        Stock
                      </Label>
                    </li>
                    <li class="flex items-center rounded-md px-2 py-1 text-sm font-medium text-gray-900 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600">
                      <Checkbox id="status" name="status" ></Checkbox>
                      <Label htmlFor="status" class="ml-2">
                        Status
                      </Label>
                    </li>
                  </ul>
                  ...
                  <ul class="space-y-1 text-sm">
                    <li class="flex items-center rounded-md px-2 py-1 text-sm font-medium text-gray-900 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600">
                      ...
                      ></Checkbox>
                      <Label htmlFor="showAdditionalInfo" class="ml-2">
                    ...
                    <li class="flex items-center rounded-md px-2 py-1 text-sm font-medium text-gray-900 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600">
                      ...
                      <Label
                        htmlFor="showImages"
                        class="rounded-md px-2 py-1 text-sm font-medium text-gray-900 dark:text-gray-300"
                      >
                        Show images
                      </Label>
                    </li>
                  ...
                  <ul class="space-y-1 text-sm">
                    <li class="flex items-center rounded-md px-2 py-1 text-sm font-medium text-gray-900 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600">
                      <Checkbox id="exportCSV" name="exportCSV" ></Checkbox>
                      <Label htmlFor="exportCSV" class="ml-2">
                        Export CSV
                      </Label>
                    </li>
                  </ul>
                  ...
                  <ul class="space-y-1 text-sm">
                    <li class="flex items-center rounded-md px-2 py-1 text-sm font-medium text-gray-900 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600">
                      <Radio defaultChecked id="normal" name="row-height" ></Radio>
                      <Label htmlFor="normal" class="ml-2">
                        Normal
                      </Label>
                    </li>
                    <li class="flex items-center rounded-md px-2 py-1 text-sm font-medium text-gray-900 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600">
                      <Radio id="compact" name="row-height" ></Radio>
                      <Label htmlFor="compact" class="ml-2">
                        Compact
                      </Label>
                    </li>
                  </ul>
                ...
                >
                  ...
                  >
                    ...
                    <div class="mt-4 flex items-center space-x-3">
                      ...
                      <PreviewProductModal ></PreviewProductModal>
