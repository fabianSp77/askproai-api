    ...
    <section class="bg-gray-50 py-3 dark:bg-gray-900 sm:py-5">
      <div class="mx-auto max-w-screen-2xl px-4 lg:px-12">
        <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
          <div class="flex flex-col px-4 pb-3 pt-4 md:flex-row md:items-center md:justify-between">
            <div>
              <Breadcrumb class="mb-2 flex w-fit rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-gray-700 dark:border-gray-600 dark:bg-gray-700">
            ...
            <Button
              @click="{ setShowNewUserModal(true) "}
              class="mt-3 md:m-0"
            >
              <svg
            ...
            >
              <Modal.Body class="relative rounded-lg bg-white p-4 shadow dark:bg-gray-800 sm:p-5">
                <div class="mb-4 flex items-center justify-between rounded-t border-b pb-4 dark:border-gray-600 sm:mb-5">
                  ...
                  <button
                    @click="{ setShowNewUserModal(false) "}
          ...
          <div class="grid w-full grid-cols-2 gap-4 px-4 pb-4 md:grid-cols-3 lg:grid-cols-5">
            <Select>
          ...
          <div class="block w-full items-center justify-between border-t px-4 py-3 dark:border-gray-700 md:flex">
            <div class="flex flex-wrap">
              <div class="mr-4 flex items-center text-sm font-medium text-gray-900 dark:text-white">
                Show:
              </div>
              <div class="mr-4 flex items-center">
                <Radio defaultChecked id="all-users" name="show-only" ></Radio>
                <label
                  htmlFor="all-users"
                  class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"
                >
              ...
              <div class="mr-4 flex items-center">
                <Radio id="sort-role" name="show-only" ></Radio>
                <label
                  htmlFor="sort-role"
                  class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"
                >
              ...
              <div class="mr-4 flex items-center">
                <Radio id="sort-type" name="show-only" ></Radio>
                <label
                  htmlFor="sort-type"
                  class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"
                >
              ...
              <div class="mr-4 flex items-center">
                <Radio id="sort-status" name="show-only" ></Radio>
                <label
                  htmlFor="sort-status"
                  class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"
                >
              ...
              <div class="mr-4 flex items-center">
                <Radio id="sort-rating" name="show-only" ></Radio>
                <label
                  htmlFor="sort-rating"
                  class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"
                >
          ...
          <div class="overflow-x-auto">
            ...
            >
              <Table.Head class="bg-gray-50 text-xs uppercase text-gray-700 dark:bg-gray-700 dark:text-gray-400">
                ...
                <Table.HeadCell scope="col" class="whitespace-nowrap p-4">
                  Account type
                </Table.HeadCell>
                <Table.HeadCell scope="col" class="p-4">
                  Rating
                ...
                <Table.Row class="border-b hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-700">
                  ...
                  >
                    <div class="mr-3 flex items-center">
                      <img
                        ...
                        alt="iMac Front"
                        class="mr-3 h-8 w-auto rounded-full"
                      ></img>
                      Jese Leos
                    </div>
                  </th>
                  <Table.Cell class="px-4 py-3">
                    <div
                      ...
                      class="inline-flex items-center rounded bg-primary-100 px-2 py-0.5 text-xs font-medium text-primary-800 dark:bg-primary-900 dark:text-primary-300"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div
                      id="tooltip-role-1"
                      role="tooltip"
                      class="tooltip invisible absolute z-10 inline-block max-w-56 rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700"
                    >
                      <h6 class="mb-1 text-sm font-medium leading-none dark:text-white">
                        Administrator
                      </h6>
                      <p class="text-xs font-medium leading-tight text-gray-500 dark:text-gray-400">
                  ...
                  <Table.Cell class="whitespace-nowrap px-4 py-3 font-medium text-gray-900 dark:text-white">
                    ...
                    >
                      <Dropdown.Item
                        @click="{ setShowUpdateUserModal(true) "}
                      >
                        <svg
                          class="mr-2 h-4 w-4"
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      <Dropdown.Item @click="{ setShowReadUserModal(true) "}>
                        <svg
                          class="mr-2 h-4 w-4"
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 20 20"
                      ...
                      <Dropdown.Item
                        @click="{ setShowDeleteUserModal(true) "}
                ...
                <Table.Row class="border-b hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-700">
                  ...
                  <Table.Cell class="px-4 py-3">
                    <div
                      ...
                      class="mr-2 inline-flex items-center rounded bg-indigo-100 px-2.5 py-0.5 text-xs font-medium text-indigo-800 dark:bg-indigo-900 dark:text-indigo-300"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="mr-1 h-3.5 w-3.5"
          ...
          <div class="flex items-center justify-between p-4 md:space-y-0">
            <Button>Download CSV</Button>
            <span class="text-sm dark:text-gray-400">
              Total users:&nbsp;
              <span class="font-medium dark:text-white">1867</span>
            </span>
          </div>
        </div>
      </div>
      ...
      >
        <Modal.Body class="relative rounded-lg bg-white p-4 shadow dark:bg-gray-800 sm:p-5">
          <div class="mb-4 flex items-center justify-between rounded-t border-b pb-4 dark:border-gray-600 sm:mb-5">
            ...
            <button
              @click="{ setShowUpdateUserModal(false) "}
              class="absolute right-5 top-[18px] ml-auto inline-flex items-center rounded-lg bg-transparent p-1.5 text-sm text-gray-400 hover:bg-gray-200 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white"
            >
              <svg
                aria-hidden
          ...
          <form action="#">
            <div class="mb-4 grid gap-4 sm:grid-cols-2">
              <div>
                <Label htmlFor="firstName" class="mb-2 block">
                  First Name
                </Label>
                <TextInput
                  defaultValue="Leslie"
              ...
              <div>
                <Label htmlFor="lastName" class="mb-2 block">
                  Last Name
                </Label>
                <TextInput
              ...
              <div class="sm:col-span-2">
                <Label htmlFor="biography" class="mb-2 block">
                  Biography
                </Label>
                <div class="w-full rounded-lg border border-gray-200 bg-gray-50 dark:border-gray-600 dark:bg-gray-700">
                  <div class="flex items-center justify-between border-b px-3 py-2 dark:border-gray-600">
                  ...
                  <div class="rounded-b-lg bg-white px-4 py-2 dark:bg-gray-800 dark:[&>textarea]:bg-gray-800">
                    <Textarea
                      id="biography"
                      placeholder="Write your biography..."
                      required
                      rows={{ 8 }}
                      class="border-0 bg-white px-0 text-sm focus:ring-0"
                    >
              ...
              <div class="sm:col-span-2">
                <Label class="mb-2 block" htmlFor="file_input">
                  Upload avatar
                </Label>
                <div class="w-full items-center sm:flex">
                  <img
                  ...
                  <div class="w-full">
                    ...
                    ></input>
                    <p
                      class="mb-3 mt-1 text-xs font-normal text-gray-500 dark:text-gray-300"
                      id="file_input_help"
                    >
                      SVG, PNG, JPG or GIF (MAX. 800x400px).
                    </p>
                    <div class="flex items-center space-x-2.5">
                      <Button
                        size="sm"
                        class="inline-flex [&>span]:text-xs"
                      >
                        <svg
              ...
              <div class="sm:col-span-2">
                <Label class="mb-2 block" htmlFor="role">
                  Assign Role
                </Label>
                <div class="space-y-4 sm:flex sm:space-y-0">
                  <div class="mr-4 flex items-center">
              ...
              <div>
                <div class="mb-2 text-sm dark:text-white">Status</div>
                <ToggleSwitch
                  checked={{ false }}
                  id="status"
                  label="Inactive"
      ...
      <Modal
        ...
        size="2xl"
      >
        <Modal.Body class="relative rounded-lg bg-white p-0 shadow dark:bg-gray-800">
          ...
          <form action="#">
            <Accordion flush class="divide-y-0 border-0">
              <Accordion.Panel>
                ...
                <Accordion.Content class="dark:bg-gray-800">
                  <div class="grid gap-4 sm:grid-cols-2">
                    ...
                    <div>
                      <Label htmlFor="first-name" class="mb-2 block">
                        First Name
                      </Label>
                      <TextInput
                        defaultValue="Bonnie"
                    ...
                    <div>
                      <Label htmlFor="last-name" class="mb-2 block">
                        Last Name
                      </Label>
                      <TextInput
                        defaultValue="Green"
                    ...
                    <div>
                      <Label htmlFor="job-title" class="mb-2 block">
                        Job Title
                      </Label>
                      <TextInput
                    ...
                    <div>
                      <Label htmlFor="languages" class="mb-2 block">
                        Languages
                      </Label>
                      <TextInput
                      ...
                      >
                        ...
                        <Tooltip content="Flowbite provides 7 predefined roles: Owner, Admin, Editor, Contributor and Viewer. Assign the most suitable role to each user, giving them the most appropriate level of control.">
                          <button class="ml-1">
                            <svg
                              aria-hidden
                              class="ml-1 h-4 w-4 text-gray-400 hover:text-gray-900 dark:text-gray-500 dark:hover:text-white"
                              fill="currentColor"
                              viewBox="0 0 20 20"
                              xmlns="http://www.w3.org/2000/svg"
                            >
                ...
                <Accordion.Content class="dark:bg-gray-800">
                  <div class="grid gap-4 sm:grid-cols-2">
                    <div class="col-span-2">
                      <Label htmlFor="skills" class="mb-2 block">
                        Skills
                      </Label>
                      <TextInput
                    ...
                    <div class="col-span-2">
                      <Label htmlFor="phone-number" class="mb-2 block">
                        Phone Number
                      </Label>
                      <TextInput
                    ...
                    <div class="col-span-2 sm:col-span-1">
                      <Label htmlFor="linkedin" class="mb-2 block">
                        Linkedin URL
                      </Label>
                      <TextInput
                    ...
                    <div class="col-span-2 sm:col-span-1">
                      <Label htmlFor="facebook" class="mb-2 block">
                        Facebook
                      </Label>
                      <TextInput
                    ...
                    <div class="col-span-2 sm:col-span-1">
                      <Label htmlFor="twitter" class="mb-2 block">
                        Twitter
                      </Label>
                      <TextInput
                    ...
                    <div class="col-span-2 sm:col-span-1">
                      <Label htmlFor="personal-website" class="mb-2 block">
                        Personal Website
                      </Label>
                      <TextInput
                    ...
                    <div class="col-span-2">
                      <Label htmlFor="country" class="mb-2 block">
                        Country
                      </Label>
                    ...
                    <div class="col-span-2 sm:col-span-1">
                      <Label htmlFor="address" class="mb-2 block">
                        Address
                      </Label>
                      <TextInput
                    ...
                    <div class="col-span-2 sm:col-span-1">
                      <Label htmlFor="timezone" class="mb-2 block">
                        Timezone
                      </Label>
                      <TextInput
                        defaultValue="GMT+3"
            ...
            <div class="flex items-center space-x-4 px-4 py-6">
              ...
              <Button
                ...
                outline
                size="lg"
                class="enabled:hover:bg-red-600 [&>span]:border-red-600 [&>span]:text-sm [&>span]:text-red-600 dark:[&>span]:bg-gray-800 dark:[&>span]:text-red-600"
              >
                <svg
      ...
      >
        <Modal.Body class="relative rounded-lg bg-white p-4 shadow dark:bg-gray-800 sm:p-5">
          <div class="mb-4 flex justify-between rounded-t sm:mb-5">
            <div class="text-lg text-gray-900 dark:text-white md:text-xl">
              <div class="flex items-center">
                <img
                  alt="Helene avatar"
                  src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/helene-engels.png"
                  class="mr-2 h-12 w-12 rounded-full sm:mr-4"
                ></img>
                <div>
                  <h3 class="text-lg font-bold text-gray-900 dark:text-white md:text-xl">
                    Helene Engels
                  </h3>
            ...
            <div>
              <button
                @click="{ setShowReadUserModal(false) "}
                class="absolute right-5 top-[18px] ml-auto inline-flex items-center rounded-lg bg-transparent p-1.5 text-sm text-gray-400 hover:bg-gray-200 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-white"
              >
                <svg
                  aria-hidden
          ...
          <div class="mb-4 grid gap-4 sm:mb-5 sm:grid-cols-2 sm:gap-6">
            <dl>
              ...
              <dd class="mb-2 flex items-center text-gray-500 dark:text-gray-400">
                <svg
                  class="mr-1.5 h-4 w-4 text-gray-400 dark:text-gray-500"
                  aria-hidden
                  fill="currentColor"
                  viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <dd class="mb-4 font-medium text-gray-900 dark:text-white sm:mb-5">
                helene@company.com
              </dd>
              <dt class="mb-2 leading-none text-gray-500 dark:text-gray-400">
                Home Adress
            ...
            <dl>
              ...
              <dd class="inline-flex items-center space-x-1">
                <a
                  href="#"
                  class="rounded-lg p-2 text-gray-500 hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
                >
                  <svg
                    class="h-5 w-5"
                    fill="currentColor"
      ...
      >
        <Modal.Body class="relative rounded-lg bg-white p-4 text-center shadow dark:bg-gray-700 sm:p-5">
          <button
            @click="{ setShowDeleteUserModal(false) "}
          ...
          <HiExclamationCircle
            aria-hidden
            class="mx-auto mb-3.5 h-14 w-14 text-gray-400 dark:text-gray-200"
          ></HiExclamationCircle>
