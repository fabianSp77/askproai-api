...
// Lazy load billing component
const LazyBilling = lazy(() => import('./Pages/Portal/Billing/IndexRefactored'));
...
const rootElement = document.getElementById('billing-index-root');
if (rootElement) {
