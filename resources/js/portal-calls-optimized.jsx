...
import { LazyCallsIndex, LazyCallShow } from './utils/lazyLoad.jsx';
import '../css/app.css';
...
const callDetailRoot = document.getElementById('call-detail-root');
...
if (callDetailRoot) {
    // Create root with concurrent features
    const root = ReactDOM.createRoot(callDetailRoot, {
        // Enable time slicing
        unstable_concurrentUpdatesByDefault: true
    });
